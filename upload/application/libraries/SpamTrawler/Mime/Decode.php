...
class SpamTrawler_Mime_Decode
{
     ...
     * @throws SpamTrawler_Exception
     */
    public static function splitMessageStruct($message, $boundary, $EOL = SpamTrawler_Mime::LINEEND)
    {
     ...
     * @return null
     */
    public static function splitMessage($message, &$headers, &$body, $EOL = SpamTrawler_Mime::LINEEND)
    {
    ...
    public static function splitHeaderField($field, $wantedPart = null, $firstName = 0)
    {
        ...
        if (!preg_match_all('%([^=\s]+)\s*=\s*("[^"]+"|[^;]+)(;\s*|$)%', $field, $matches)) {
            throw new SpamTrawler_Exception('not a valid header field');
        }
