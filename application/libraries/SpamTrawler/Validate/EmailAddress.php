 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_EmailAddress extends SpamTrawler_Validate_Abstract
{
    ...
    protected $_options = array(
        ...
        'deep'     => false,
        'domain'   => true,
        'allow'    => SpamTrawler_Validate_Hostname::ALLOW_DNS,
        'hostname' => null
    );
     ...
     * 'hostname' => A hostname validator, see SpamTrawler_Validate_Hostname
     * 'allow'    => Options for the hostname validator, see SpamTrawler_Validate_Hostname::ALLOW_*
     * 'mx'       => If MX check should be enabled, boolean
     * 'deep'     => If a deep MX check should be done, boolean
     *
     * @param array|string|SpamTrawler_Config $options OPTIONAL
     */
     ...
     *
     * @param array $options
     * @return SpamTrawler_Validate_EmailAddress Provides a fluent inteface
     */
     ...
     *
     * @return SpamTrawler_Validate_Hostname
     */
    ...
    /**
     * @param SpamTrawler_Validate_Hostname $hostnameValidator OPTIONAL
     * @param int                    $allow             OPTIONAL
     * @return $this
     */
    public function setHostnameValidator(SpamTrawler_Validate_Hostname $hostnameValidator = null, $allow = SpamTrawler_Validate_Hostname::ALLOW_DNS)
    {
        if (!$hostnameValidator) {
            $hostnameValidator = new SpamTrawler_Validate_Hostname($allow);
        }
    ...
    public function setValidateMx($mx)
    {
        if ((bool) $mx && !$this->validateMxSupported()) {
            ...
            throw new SpamTrawler_Validate_Exception('MX checking not available on this system');
        }
