...
/**
 * YAML Adapter for SpamTrawler_Config
 *
 * @category  SpamTrawler
 * @package   SpamTrawler_Config
 * @copyright Copyright (c) 2005-2014 SpamTrawler Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Config_Yaml extends SpamTrawler_Config
{
    /**
    ...
    public function setYamlDecoder($yamlDecoder)
    {
        if (!is_callable($yamlDecoder)) {
            ...
            throw new SpamTrawler_Config_Exception('Invalid parameter to setYamlDecoder() - must be callable');
        }
    ...
    public function __construct($yaml, $section = null, $options = false)
    {
        ...
        if (null === $config) {
            // decode failed
            require_once 'SpamTrawler/Config/Exception.php';
            throw new SpamTrawler_Config_Exception("Error parsing YAML data");
        }
        ...
        if (null === $section) {
            ...
            foreach ($section as $sectionName) {
                if (!isset($config[$sectionName])) {
                    require_once 'SpamTrawler/Config/Exception.php';
                    throw new SpamTrawler_Config_Exception(sprintf(
