 ...
 * @version    $Id$
 */
class SpamTrawler_Log_Formatter_Xml extends SpamTrawler_Log_Formatter_Abstract
{
    /**
    ...
    /**
	 * Factory for SpamTrawler_Log_Formatter_Xml classe
	 *
	 * @param array|SpamTrawler_Config $options
	 * @return SpamTrawler_Log_Formatter_Xml
     */
