...
/**
 * @see SpamTrawler_Mail_Storage_Folder_Maildir
 */
require_once 'SpamTrawler/Mail/Storage/Folder/Maildir.php';

/**
 * @see SpamTrawler_Mail_Storage_Writable_Interface
 */
require_once 'SpamTrawler/Mail/Storage/Writable/Interface.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Storage_Writable_Maildir extends    SpamTrawler_Mail_Storage_Folder_Maildir
                                         implements SpamTrawler_Mail_Storage_Writable_Interface
{
    ...
    public static function initMaildir($dir)
    {
        if (file_exists($dir)) {
            if (!is_dir($dir)) {
                /**
                 * @see SpamTrawler_Mail_Storage_Exception
                 */
                require_once 'SpamTrawler/Mail/Storage/Exception.php';
                throw new SpamTrawler_Mail_Storage_Exception('maildir must be a directory if already exists');
            }
        } else {
            if (!mkdir($dir)) {
                /**
                ...
                $dir = dirname($dir);
                if (!file_exists($dir)) {
                    throw new SpamTrawler_Mail_Storage_Exception("parent $dir not found");
                } else if (!is_dir($dir)) {
                    throw new SpamTrawler_Mail_Storage_Exception("parent $dir not a directory");
                } else {
                    throw new SpamTrawler_Mail_Storage_Exception('cannot create maildir');
                }
            }
        }
        ...
        foreach (array('cur', 'tmp', 'new') as $subdir) {
            if (!@mkdir($dir . DIRECTORY_SEPARATOR . $subdir)) {
                ...
                if (!file_exists($dir . DIRECTORY_SEPARATOR . $subdir)) {
                     ...
                     */
                    require_once 'SpamTrawler/Mail/Storage/Exception.php';
                    throw new SpamTrawler_Mail_Storage_Exception('could not create subdir ' . $subdir);
                }
            }
        }
    }
     ...
     * @param   string|SpamTrawler_Mail_Storage_Folder $parentFolder parent folder for new folder, else root folder is parent
     * @return  string only used internally (new created maildir)
     * @throws  SpamTrawler_Mail_Storage_Exception
     */
    public function createFolder($name, $parentFolder = null)
    {
        if ($parentFolder instanceof SpamTrawler_Mail_Storage_Folder) {
        ...
        } catch (SpamTrawler_Mail_Exception $e) {
            // ok
        }
        if ($exists) {
            /**
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('folder already exists');
        }
        ...
        if (strpos($folder, $this->_delim . $this->_delim) !== false) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('invalid name - folder parts may not be empty');
        }
        ...
        if (strpos($folder, DIRECTORY_SEPARATOR) !== false || strpos($folder, '/') !== false
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('invalid name - no directory seprator allowed in folder name');
        }
        ...
        if (!@mkdir($fulldir) || !@mkdir($fulldir . DIRECTORY_SEPARATOR . 'cur')) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('error while creating new folder, may be created incompletly');
        }
        ...
        $this->getFolders($parent)->$localName = new SpamTrawler_Mail_Storage_Folder($localName, $folder, true);
     ...
     * remove a folder
     *
     * @param   string|SpamTrawler_Mail_Storage_Folder $name      name or instance of folder
     * @return  null
     * @throws  SpamTrawler_Mail_Storage_Exception
     */
    public function removeFolder($name)
    {
        ...
        if ($name instanceof SpamTrawler_Mail_Storage_Folder) {
        ...
        if (!$this->getFolders($name)->isLeaf()) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('delete children first');
        }
        ...
        if ($name == 'INBOX' || $name == DIRECTORY_SEPARATOR || $name == '/') {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('wont delete INBOX');
        }
        ...
        if ($name == $this->getCurrentFolder()) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('wont delete selected folder');
        }
        ...
        foreach (array('tmp', 'new', 'cur', '.') as $subdir) {
            ...
            if (!$dh) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Storage/Exception.php';
                throw new SpamTrawler_Mail_Storage_Exception("error opening $subdir");
            }
            while (($entry = readdir($dh)) !== false) {
                ...
                if (!unlink($dir . DIRECTORY_SEPARATOR . $entry)) {
                     ...
                     */
                    require_once 'SpamTrawler/Mail/Storage/Exception.php';
                    throw new SpamTrawler_Mail_Storage_Exception("error cleaning $subdir");
                }
            }
            closedir($dh);
            if ($subdir !== '.') {
                if (!rmdir($dir)) {
                     ...
                     */
                    require_once 'SpamTrawler/Mail/Storage/Exception.php';
                    throw new SpamTrawler_Mail_Storage_Exception("error removing $subdir");
                }
            }
        }
        ...
        if (!rmdir($this->_rootdir . '.' . $name)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception("error removing maindir");
        }
     ...
     *
     * @param   string|SpamTrawler_Mail_Storage_Folder $oldName name or instance of folder
    ...
    public function renameFolder($oldName, $newName)
    {
        ...
        if ($oldName instanceof SpamTrawler_Mail_Storage_Folder) {
        ...
        if (strpos($newName, $oldName . $this->_delim) === 0) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('new folder cannot be a child of old folder');
        }
        ...
        if ($oldName == 'INBOX' || $oldName == DIRECTORY_SEPARATOR || $oldName == '/') {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('wont rename INBOX');
        }
        ...
        if ($oldName == $this->getCurrentFolder()) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('wont rename selected folder');
        }
        ...
        foreach (array('tmp', 'new', 'cur') as $subdir) {
            ...
            if (!rename($olddir . $subdir, $newdir . $subdir)) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Storage/Exception.php';
                throw new SpamTrawler_Mail_Storage_Exception('error while moving ' . $subdir);
            }
        }
    ...
    protected function _createTmpFile($folder = 'INBOX')
    {
        ...
        if (!file_exists($tmpdir)) {
            if (!mkdir($tmpdir)) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Storage/Exception.php';
                throw new SpamTrawler_Mail_Storage_Exception('problems creating tmp dir');
            }
        }
        ...
        for ($i = 0; $i < $max_tries; ++$i) {
            ...
            if (!file_exists($tmpdir . $uniq)) {
                ...
                if (!$fh) {
                     ...
                     */
                    require_once 'SpamTrawler/Mail/Storage/Exception.php';
                    throw new SpamTrawler_Mail_Storage_Exception('could not open temp file');
                }
                break;
            }
            sleep(1);
        ...
        if (!$fh) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception("tried $max_tries unique ids for a temp file, but all were taken"
                                                . ' - giving up');
        }
    ...
    protected function _getInfoString(&$flags)
    {
        ...
        if (isset($wanted_flags[SpamTrawler_Mail_Storage::FLAG_RECENT])) {
            /**
             * @see SpamTrawler_Mail_Storage_Exception
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('recent flag may not be set');
        }

        $info = ':2,';
        $flags = array();
        foreach (SpamTrawler_Mail_Storage_Maildir::$_knownFlags as $char => $flag) {
        ...
        if (!empty($wanted_flags)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('unknown flag(s): ' . $wanted_flags);
        }
     ...
     * @param   null|string|SpamTrawler_Mail_Storage_Folder       $folder  folder for new message, else current folder is taken
     * @param   null|array                                 $flags   set flags for new message, else a default set is used
     * @param   bool                                       $recent  handle this mail as if recent flag has been set,
     *                                                              should only be used in delivery
     * @throws  SpamTrawler_Mail_Storage_Exception
     */
     // not yet * @param string|SpamTrawler_Mail_Message|SpamTrawler_Mime_Message $message message as string or instance of message class
    ...
    public function appendMessage($message, $folder = null, $flags = null, $recent = false)
    {
        if ($this->_quota && $this->checkQuota()) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('storage is over quota!');
        }
        ...
        if (!($folder instanceof SpamTrawler_Mail_Storage_Folder)) {
            $folder = $this->getFolders($folder);
        }

        if ($flags === null) {
            $flags = array(SpamTrawler_Mail_Storage::FLAG_SEEN);
        }
        ...
        if (!link($temp_file['filename'], $new_filename)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            $exception = new SpamTrawler_Mail_Storage_Exception('cannot link message file to final dir');
        }
     ...
     * @param   string|SpamTrawler_Mail_Storage_Folder $folder name or instance of targer folder
     * @return  null
     * @throws  SpamTrawler_Mail_Storage_Exception
     */
    public function copyMessage($id, $folder)
    {
        ...
        while (($key = array_search(SpamTrawler_Mail_Storage::FLAG_RECENT, $flags)) !== false) {
            unset($flags[$key]);
        }
        $info = $this->_getInfoString($flags);
        ...
        if (!copy($old_file, $temp_file['filename'])) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            $exception = new SpamTrawler_Mail_Storage_Exception('cannot copy message file');
    ...
    public function moveMessage($id, $folder) {
        ...
        if ($folder->getGlobalName() == $this->_currentFolder
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('target is current folder');
        }
        ...
        if (!rename($old_file, $new_file)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            $exception = new SpamTrawler_Mail_Storage_Exception('cannot move message file');
        }
        @unlink($temp_file['filename']);
    ...
    public function setFlags($id, $flags)
    {
        ...
        if (!@rename($filedata['filename'], $new_filename)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('cannot rename file');
        }
    ...
    public function removeMessage($id)
    {
        ...
        if (!@unlink($filename)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('cannot remove message');
        }
        unset($this->_files[$id - 1]);
        // remove the gap
        $this->_files = array_values($this->_files);
     ...
     *
     * @see SpamTrawler_Mail_Storage_Writable_Maildir::setQuota()
     *
     * @return bool|array
     */
    public function getQuota($fromStorage = false) {
        if ($fromStorage) {
            ...
            if (!$fh) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Storage/Exception.php';
                throw new SpamTrawler_Mail_Storage_Exception('cannot open maildirsize');
            }
            $definition = fgets($fh);
            fclose($fh);
    ...
    protected function _calculateMaildirsize() {
        ...
        if (is_array($this->_quota)) {
            ...
            } catch (SpamTrawler_Mail_Storage_Exception $e) {
                throw new SpamTrawler_Mail_Storage_Exception('no quota definition found', 0, $e);
            }
        }
