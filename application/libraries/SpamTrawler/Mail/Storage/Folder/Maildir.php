...
/**
 * @see SpamTrawler_Mail_Storage_Maildir
 */
require_once 'SpamTrawler/Mail/Storage/Maildir.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Storage_Folder_Maildir extends SpamTrawler_Mail_Storage_Maildir implements SpamTrawler_Mail_Storage_Folder_Interface
{
    /**
    ...
    protected function _buildFolderTree()
    {
        ...
        $this->_rootFolder->INBOX = new SpamTrawler_Mail_Storage_Folder('INBOX', 'INBOX', true);
        ...
        if (!$dh) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception("can't read folders in maildir");
        }
        $dirs = array();
            ...
            do {
                if (strpos($dir, $parent) === 0) {
                    ...
                    if (strpos($local, $this->_delim) !== false) {
                         ...
                         */
                        require_once 'SpamTrawler/Mail/Storage/Exception.php';
                        throw new SpamTrawler_Mail_Storage_Exception('error while reading maildir');
                    }
                    array_push($stack, $parent);
                    $parent = $dir . $this->_delim;
                    $folder = new SpamTrawler_Mail_Storage_Folder($local, substr($dir, 1), true);
    ...
    public function selectFolder($globalName)
    {
        ...
        try {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('seems like the maildir has vanished, I\'ve rebuild the ' .
