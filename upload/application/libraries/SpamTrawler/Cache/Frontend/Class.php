 ...
 * @license    http://framework.zend.com/license/new-bsd New BSD License
 */
class SpamTrawler_Cache_Frontend_Class extends SpamTrawler_Cache_Core
{
    /**
     * Available options
     *
    ...
    public function __construct(array $options = array())
    {
        ...
        if ($this->_specificOptions['cached_entity'] === null) {
            SpamTrawler_Cache::throwException('cached_entity must be set !');
        }
    ...
    public function setCachedEntity($cachedEntity)
    {
        if (!is_string($cachedEntity) && !is_object($cachedEntity)) {
            SpamTrawler_Cache::throwException(
