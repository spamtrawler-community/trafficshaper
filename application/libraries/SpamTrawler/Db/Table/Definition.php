 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Table_Definition
{
     ...
     * @return SpamTrawler_Db_Table_Definition
     */
    ...
    {
        // @todo logic here
        $tableConfig[SpamTrawler_Db_Table::DEFINITION_CONFIG_NAME] = $tableName;
        $tableConfig[SpamTrawler_Db_Table::DEFINITION] = $this;

        if (!isset($tableConfig[SpamTrawler_Db_Table::NAME])) {
            $tableConfig[SpamTrawler_Db_Table::NAME] = $tableName;
        }
