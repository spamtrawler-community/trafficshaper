...
class Firewall_ASNWhitelist_Controller_Export extends SpamTrawler_BaseClasses_Modules_Controller {
    private $aConfig = array(
        'dbTableName' => 'whitelist_asn',
    ...
    {
        $oImport = new Firewall_ASNWhitelist_Model_Export($this->aConfig);
