 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_ImageSize extends SpamTrawler_Validate_Abstract
{
    /**
     ...
     * - maxwidth
     *
     * @param  SpamTrawler_Config|array $options
    ...
    public function __construct($options)
    {
        if ($options instanceof SpamTrawler_Config) {
            ...
            throw new SpamTrawler_Validate_Exception ('Invalid options to validator provided');
        }
     ...
     * @throws SpamTrawler_Validate_Exception      When minwidth is greater than maxwidth
     * @throws SpamTrawler_Validate_Exception      When minheight is greater than maxheight
     * @return SpamTrawler_Validate_File_ImageSize Provides a fluent interface
     */
    public function setImageMin($options)
    {
        if (isset($options['minwidth'])) {
            if (($this->_maxwidth !== null) and ($options['minwidth'] > $this->_maxwidth)) {
                require_once 'SpamTrawler/Validate/Exception.php';
                throw new SpamTrawler_Validate_Exception("The minimum image width must be less than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_maxheight !== null) and ($options['minheight'] > $this->_maxheight)) {
                require_once 'SpamTrawler/Validate/Exception.php';
                throw new SpamTrawler_Validate_Exception("The minimum image height must be less than or equal to the "
     ...
     * @throws SpamTrawler_Validate_Exception When maxwidth is smaller than minwidth
     * @throws SpamTrawler_Validate_Exception When maxheight is smaller than minheight
     * @return SpamTrawler_Validate_StringLength Provides a fluent interface
     */
    public function setImageMax($options)
    {
        if (isset($options['maxwidth'])) {
            if (($this->_minwidth !== null) and ($options['maxwidth'] < $this->_minwidth)) {
                require_once 'SpamTrawler/Validate/Exception.php';
                throw new SpamTrawler_Validate_Exception("The maximum image width must be greater than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_minheight !== null) and ($options['maxheight'] < $this->_minheight)) {
                require_once 'SpamTrawler/Validate/Exception.php';
                throw new SpamTrawler_Validate_Exception("The maximum image height must be greater than or equal to the "
     ...
     * @param  array  $file  File data from SpamTrawler_File_Transfer
     * @return boolean
     */
    public function isValid($value, $file = null)
    {
        ...
        if (!SpamTrawler_Loader::isReadable($value)) {
