 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Cache_Backend_Memcached extends SpamTrawler_Cache_Backend implements SpamTrawler_Cache_Backend_ExtendedInterface
{
    /**
     * Default Values
     */
     ...
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_MEMCACHED_BACKEND = 'SpamTrawler_Cache_Backend_Memcached::clean() : tags are unsupported by the Memcached backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_MEMCACHED_BACKEND =  'SpamTrawler_Cache_Backend_Memcached::save() : tags are unsupported by the Memcached backend';
    ...
    public function __construct(array $options = array())
    {
        if (!extension_loaded('memcache')) {
            SpamTrawler_Cache::throwException('The memcache extension must be loaded for using this backend !');
        }
    ...
    public function clean($mode = SpamTrawler_Cache::CLEANING_MODE_ALL, $tags = array())
    {
        switch ($mode) {
            ...
            case SpamTrawler_Cache::CLEANING_MODE_OLD:
                $this->_log("SpamTrawler_Cache_Backend_Memcached::clean() : CLEANING_MODE_OLD is unsupported by the Memcached backend");
                break;
    ...
    {
        $this->_log("SpamTrawler_Cache_Backend_Memcached::save() : getting the list of cache ids is unsupported by the Memcache backend");
        return array();
    }
