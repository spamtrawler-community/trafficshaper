 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_Callback implements SpamTrawler_Filter_Interface
{
    /**
    ...
    public function __construct($options)
    {
        ...
        if (!array_key_exists('callback', $options)) {
            ...
            throw new SpamTrawler_Filter_Exception('Missing callback to use');
        }
     ...
     * @return SpamTrawler_Filter_Callback
     */
