 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Identical extends SpamTrawler_Validate_Abstract
{
    /**
     * Error codes
     * @const string
    ...
    {
        if ($token instanceof SpamTrawler_Config) {
            $token = $token->toArray();
        }
     ...
     *
     * @param  mixed $token
     * @return SpamTrawler_Validate_Identical
     */
     ...
     *
     * @param SpamTrawler_Validate_Identical
     * @return $this
     */
