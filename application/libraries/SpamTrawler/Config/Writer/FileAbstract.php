...
require_once "SpamTrawler/Config/Writer.php";

/**
 * Abstract File Writer
 *
 * @category   SpamTrawler
 * @package    SpamTrawler_package
 * @copyright  Copyright (c) 2005-2014 SpamTrawler Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id$
 */
class SpamTrawler_Config_Writer_FileAbstract extends SpamTrawler_Config_Writer
{
    /**
     ...
     * @return SpamTrawler_Config_Writer_Array
     */
     ...
     * @return void
     */
    public function write($filename = null, SpamTrawler_Config $config = null, $exclusiveLock = null)
    {
        if ($filename !== null) {
        ...
        if ($this->_filename === null) {
            ...
            throw new SpamTrawler_Config_Exception('No filename was set');
        }

        if ($this->_config === null) {
            require_once 'SpamTrawler/Config/Exception.php';
            throw new SpamTrawler_Config_Exception('No config was set');
        }
        ...
        if ($result === false) {
            require_once 'SpamTrawler/Config/Exception.php';
            throw new SpamTrawler_Config_Exception('Could not write to file "' . $this->_filename . '"');
        }
    }

    /**
     * Render a SpamTrawler_Config into a config file string.
     *
     * @since 1.10
