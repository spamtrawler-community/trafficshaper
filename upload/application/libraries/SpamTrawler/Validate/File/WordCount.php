...
/**
 * @see SpamTrawler_Validate_File_Count
 */
require_once 'SpamTrawler/Validate/File/Count.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_WordCount extends SpamTrawler_Validate_File_Count
{
    /**#@+
