...
/**
 * @see SpamTrawler_Validate_File_Size
 */
require_once 'SpamTrawler/Validate/File/Size.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_FilesSize extends SpamTrawler_Validate_File_Size
{
    /**
     ...
     *
     * @param  integer|array|SpamTrawler_Config $options Options for this validator
    ...
    public function isValid($value, $file = null)
    {
        ...
        foreach ($value as $files) {
            // Is file readable ?
            if (!SpamTrawler_Loader::isReadable($files)) {
