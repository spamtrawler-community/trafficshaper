...
class Firewall_IPBlacklist_Controller_Manage extends SpamTrawler_BaseClasses_Modules_Controller
{
    ...
    public function get()
    {
        $oManage = $oManage = new Firewall_IPBlacklist_Model_Manage;
        $oManage->get();
    }
    ...
    public function create()
    {
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if(isset($_GET['ip'])){
                $sModels = '[{"id":"","ip":"' . $_GET['ip'] . '","comment":"","updated":""}]';
            } else {
                exit('No Data Received!');
            }
        }
        //Model constructor expects $oInput to be object
        $oManage = new Firewall_IPBlacklist_Model_Manage(json_decode($sModels));
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
        	...
        	exit('IP has been Blacklisted successfully!');
        }
    }

    public function update()
    {
        $oManage = new Firewall_IPBlacklist_Model_Manage(json_decode($_POST['models']));
