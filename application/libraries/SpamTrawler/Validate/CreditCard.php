 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_CreditCard extends SpamTrawler_Validate_Abstract
{
    /**
     * Detected CCI list
     *
     ...
     * Constructor
     *
     * @param string|array|SpamTrawler_Config $options OPTIONAL Type of CCI to allow
     */
     ...
     * @return SpamTrawler_Validate_CreditCard Provides a fluent interface
     */
    ...
    public function setService($service)
    {
        if (!is_callable($service)) {
            ...
            throw new SpamTrawler_Validate_Exception('Invalid callback given');
        }
    ...
    public function isValid($value)
    {
        ...
        if (!empty($this->_service)) {
            try {
                require_once 'SpamTrawler/Validate/Callback.php';
                $callback = new SpamTrawler_Validate_Callback($this->_service);
