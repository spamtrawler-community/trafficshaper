 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_Compress implements SpamTrawler_Filter_Interface
{
    /**
     * Compression adapter
     */
    ...
    public function __construct($options = null)
    {
        ...
        } elseif ($options instanceof SpamTrawler_Filter_Compress_CompressInterface) {
            $this->setAdapter($options);
     ...
     *
     * @param  array $options
     * @return SpamTrawler_Filter_Compress
     */
    ...
    {
        if ($this->_adapter instanceof SpamTrawler_Filter_Compress_CompressInterface) {
        ...
        if (!class_exists($adapter)) {
            ...
            if (SpamTrawler_Loader::isReadable('SpamTrawler/Filter/Compress/' . ucfirst($adapter) . '.php')) {
                $adapter = 'SpamTrawler_Filter_Compress_' . ucfirst($adapter);
            }
        ...
        if (!$this->_adapter instanceof SpamTrawler_Filter_Compress_CompressInterface) {
            ...
            throw new SpamTrawler_Filter_Exception("Compression adapter '" . $adapter . "' does not implement SpamTrawler_Filter_Compress_CompressInterface");
        }
        return $this->_adapter;
    }
     ...
     *
     * @param  string|SpamTrawler_Filter_Compress_CompressInterface $adapter Adapter to use
     * @return SpamTrawler_Filter_Compress
     */
    public function setAdapter($adapter)
    {
        if ($adapter instanceof SpamTrawler_Filter_Compress_CompressInterface) {
            $this->_adapter = $adapter;
            return $this;
        }
        if (!is_string($adapter)) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception('Invalid adapter provided; must be string or instance of SpamTrawler_Filter_Compress_CompressInterface');
        }
        $this->_adapter = $adapter;
