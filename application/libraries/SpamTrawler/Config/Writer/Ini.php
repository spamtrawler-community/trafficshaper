 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Config_Writer_Ini extends SpamTrawler_Config_Writer_FileAbstract
{
    /**
     ...
     * @return SpamTrawler_Config_Writer_Ini
     */
    ...
    /**
     * Render a SpamTrawler_Config into a INI config string.
     *
     * @since 1.10
     * @return string
     */
     ...
     * @return void
     */
    protected function _addBranch(SpamTrawler_Config $config, $parents = array())
    {
        $iniString = '';
    ...
    protected function _prepareValue($value)
    {
        if (is_integer($value) || is_float($value)) {
            ...
            throw new SpamTrawler_Config_Exception('Value can not contain double quotes "');
        }
    }
     ...
     * @param  SpamTrawler_Config
     * @return SpamTrawler_Config
     */
    protected function _sortRootElements(SpamTrawler_Config $config)
    {
        ...
        return new SpamTrawler_Config($configArray);
    }
}
