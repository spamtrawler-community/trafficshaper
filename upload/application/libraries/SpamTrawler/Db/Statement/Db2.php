 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Statement_Db2 extends SpamTrawler_Db_Statement
{
     ...
     * @param string $sql
     * @return void
     * @throws SpamTrawler_Db_Statement_Db2_Exception
     */
    public function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            /**
             * @see SpamTrawler_Db_Statement_Db2_Exception
             */
            require_once 'SpamTrawler/Db/Statement/Db2/Exception.php';
            throw new SpamTrawler_Db_Statement_Db2_Exception(
                db2_stmt_errormsg(),
                db2_stmt_error()
            );
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                require_once 'SpamTrawler/Db/Statement/Db2/Exception.php';
                throw new SpamTrawler_Db_Statement_Db2_Exception("Invalid fetch mode '$style' specified");
                break;
        }
    ...
    {
        $obj = $this->fetch(SpamTrawler_Db::FETCH_OBJ);
        return $obj;
    }
    ...
    public function nextRowset()
    {
         ...
         */
        require_once 'SpamTrawler/Db/Statement/Db2/Exception.php';
        throw new SpamTrawler_Db_Statement_Db2_Exception(__FUNCTION__ . '() is not implemented');
    }
