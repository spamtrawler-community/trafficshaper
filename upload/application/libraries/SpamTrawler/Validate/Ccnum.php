 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Ccnum extends SpamTrawler_Validate_Abstract
{
    /**
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
            /**
             * @see SpamTrawler_Filter_Digits
             */
            require_once 'SpamTrawler/Filter/Digits.php';
            self::$_filter = new SpamTrawler_Filter_Digits();
        }
