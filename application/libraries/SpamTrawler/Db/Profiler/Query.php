 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Profiler_Query
{
    ...
    /**
     * One of the SpamTrawler_Db_Profiler constants for query type, set by $queryType argument in constructor.
     *
     * @var integer
     */
     ...
     * type (one of the SpamTrawler_Db_Profiler::* constants).
     *
     * @param  string  $query
    ...
    /**
     * Get the type of this query (one of the SpamTrawler_Db_Profiler::* constants)
     *
     * @return integer
     */
