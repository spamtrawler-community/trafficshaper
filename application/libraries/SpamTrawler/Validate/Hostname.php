...
/**
 * @see SpamTrawler_Validate_Ip
 */
require_once 'SpamTrawler/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/SpamTrawler/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/SpamTrawler/Validate/HostnameTestForm.php which is designed to be run via HTML
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Hostname extends SpamTrawler_Validate_Abstract
{
     ...
     *
     * @return SpamTrawler_Validate_Ip
     */
    ...
    /**
     * @param SpamTrawler_Validate_Ip $ipValidator OPTIONAL
     * @return SpamTrawler_Validate_Hostname
     */
    public function setIpValidator(SpamTrawler_Validate_Ip $ipValidator = null)
    {
        if ($ipValidator === null) {
            $ipValidator = new SpamTrawler_Validate_Ip();
        }
     ...
     *
     * @param  integer $allow
     * @return SpamTrawler_Validate_Hostname Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @throws SpamTrawler_Validate_Exception if a fatal error occurs for validation process
     * @return boolean
     */
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            do {
                ...
                if (preg_match('/([^.]{2,63})$/iu', end($domainParts), $matches)
                     ...
                     * @see SpamTrawler_Validate_Hostname_Interface
                     */
