...
/**
 * @see SpamTrawler_Filter_SeperatorToSeparator
 */
require_once 'SpamTrawler/Filter/Word/SeparatorToSeparator.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_Word_SeparatorToDash extends SpamTrawler_Filter_Word_SeparatorToSeparator
{
    /**
     * Constructor
     *
