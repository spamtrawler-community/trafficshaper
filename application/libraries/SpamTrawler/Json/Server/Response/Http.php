...
/**
 * @see SpamTrawler_Json_Server_Response
 */
require_once 'SpamTrawler/Json/Server/Response.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Json_Server_Response_Http extends SpamTrawler_Json_Server_Response
{
    /**
     * Emit JSON
     *
