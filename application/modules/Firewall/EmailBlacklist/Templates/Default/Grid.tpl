...
<div class="row">
    <div class="small-4 columns">
        <input type="text" id="query_emailblacklist" class="radius" value="" placeholder="Search">
    </div>
    <div class="small-2 columns">
        <select id="column_emailblacklist" class="radius">
            <option value="email">Email</option>
            <option value="comment">Comment</option>
        </select>
    </div>
    <div class="small-2 columns">
        <select id="operator_emailblacklist" class="radius">
    ...
    <div class="small-2 columns">
        <input type="button" id="btnFilter_emailblacklist" class="k-button" value="Filter">
        <input type="button" id="btnReset_emailblacklist" class="k-button" value="Reset">
    </div>
</div>

<div id="gridEmailBlacklist"></div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#gridEmailBlacklist").kendoGrid({
                    ...
                    detailTemplate: kendo.template($("#commentTemplateEmailBlacklist").html()),
                    toolbar: ["create"],
                    columns: [
                        {
                            field: "email",
                ...
                $("#btnFilter_emailblacklist").on("click", function(e) {
                    var ds = $("#gridEmailBlacklist").data("kendoGrid").dataSource;
                    ds.filter([{
                        "field": $("#column_emailblacklist").val(),
                        "operator": $("#operator_emailblacklist").val(),
                        "value": $("#query_emailblacklist").val()}
                    ]);
                });

                $("#btnReset_emailblacklist").on("click", function(e) {
                    $("#query_emailblacklist").val('');
                    var ds = $("#gridEmailBlacklist").data("kendoGrid").dataSource;
                    ds.filter([]);
                });
            });
...
<!-- popup editor template -->
    <script id="popup_editorEmailBlacklist" type="text/x-kendo-template">
       <div id="errorsEmailBlacklist">Shows Errors here!</div>
    </script>

        <script type="text/x-kendo-template" id="commentTemplateEmailBlacklist">
            <div class="row">
                <div>Comment:</div>
