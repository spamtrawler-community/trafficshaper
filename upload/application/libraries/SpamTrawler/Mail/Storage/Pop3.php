...
/**
 * @see SpamTrawler_Mail_Protocol_Pop3
 */
require_once 'SpamTrawler/Mail/Protocol/Pop3.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Storage_Pop3 extends SpamTrawler_Mail_Storage_Abstract
{
    /**
     * protocol handler
     * @var null|SpamTrawler_Mail_Protocol_Pop3
     */
    protected $_protocol;
    ...
    public function getRawContent($id, $part = null)
    {
        ...
        SpamTrawler_Mime_Decode::splitMessage($content, $null, $body);
        return $body;
    }
    ...
    public function __construct($params)
    {
        ...
        if ($params instanceof SpamTrawler_Mail_Protocol_Pop3) {
        ...
        $this->_protocol = new SpamTrawler_Mail_Protocol_Pop3();
     ...
     *
     * @see SpamTrawler_Mail_Storage_Abstract:__get()
     * @param  string $var
     * @return string
     * @throws SpamTrawler_Mail_Storage_Exception
     */
