 ...
 * are re-thrown as SpamTrawler_Db_Statement_Exception.
 *
 * @category   SpamTrawler
 * @package    SpamTrawler_Db
 * @subpackage Statement
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Statement_Pdo extends SpamTrawler_Db_Statement implements IteratorAggregate
{
    ...
    public function _execute(array $params = null)
    {
        try {
            ...
            throw new SpamTrawler_Db_Statement_Exception($message, (int) $e->getCode(), $e);
        }
    }
