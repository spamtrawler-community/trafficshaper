...
class Firewall_HostnameBlacklist_Controller_Manage extends SpamTrawler_BaseClasses_Modules_Controller
{
    ...
    public function get()
    {
        $oManage = $oManage = new Firewall_HostnameBlacklist_Model_Manage;
        $oManage->get();
    }
    ...
    public function create()
    {
        ...
        $oManage = new Firewall_HostnameBlacklist_Model_Manage(json_decode($sModels));
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            exit('Hostname has been Blacklisted successfully!');
        }
    }

    public function update()
    {
        $oManage = new Firewall_HostnameBlacklist_Model_Manage(json_decode($_POST['models']));
    ...
    {
        $oManage = new Firewall_HostnameBlacklist_Model_Manage(NULL);
        $oManage->deleteCache();
    }
}
