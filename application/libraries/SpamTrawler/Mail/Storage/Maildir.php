...
/**
 * @see SpamTrawler_Mail_Message_File
 */
require_once 'SpamTrawler/Mail/Message/File.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Storage_Maildir extends SpamTrawler_Mail_Storage_Abstract
{
    /**
     * used message class, change it in an extened class to extend the returned message class
     * @var string
     */
    protected $_messageClass = 'SpamTrawler_Mail_Message_File';
     ...
     * @var array
     */
    protected static $_knownFlags = array('D' => SpamTrawler_Mail_Storage::FLAG_DRAFT,
                                          'F' => SpamTrawler_Mail_Storage::FLAG_FLAGGED,
                                          'P' => SpamTrawler_Mail_Storage::FLAG_PASSED,
                                          'R' => SpamTrawler_Mail_Storage::FLAG_ANSWERED,
                                          'S' => SpamTrawler_Mail_Storage::FLAG_SEEN,
                                          'T' => SpamTrawler_Mail_Storage::FLAG_DELETED);
    ...
    protected function _getFileData($id, $field = null)
    {
        if (!isset($this->_files[$id - 1])) {
            ...
            throw new SpamTrawler_Mail_Storage_Exception('id does not exist');
        }
        ...
        if (!isset($this->_files[$id - 1][$field])) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('field does not exist');
        }
     ...
     * @return SpamTrawler_Mail_Message_File
     * @throws SpamTrawler_Mail_Storage_Exception
     */
    ...
    public function __construct($params)
    {
        ...
        if (!$this->_isMaildir($params->dirname)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('invalid maildir given');
        }
    ...
    protected function _openMaildir($dirname)
    {
        ...
        if (!$dh) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('cannot open maildir');
        }
        ...
        if ($dh) {
            $this->_getMaildirFiles($dh, $dirname . '/new/', array(SpamTrawler_Mail_Storage::FLAG_RECENT));
            closedir($dh);
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('cannot read recent mails in maildir');
        }
    }
    ...
    public function removeMessage($id)
    {
         ...
         */
        require_once 'SpamTrawler/Mail/Storage/Exception.php';
        throw new SpamTrawler_Mail_Storage_Exception('maildir is (currently) read-only');
    }
