...
class Firewall_IPRangesBlacklist_Controller_Import extends SpamTrawler_BaseClasses_Modules_Controller {
    ...
    private function fileUpload()
    {
        if(is_uploaded_file($_FILES['importfile']['tmp_name'])) {
            ...
            try{
                ...
                exit('An Error Occured while importing the IP Ranges Blacklist:<br />' . $e);
            }
        } else {
