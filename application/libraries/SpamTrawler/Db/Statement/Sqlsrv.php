 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Statement_Sqlsrv extends SpamTrawler_Db_Statement
{
     ...
     * @param string $sql
     * @return void
     * @throws SpamTrawler_Db_Statement_Sqlsrv_Exception
     */
    protected function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            require_once 'SpamTrawler/Db/Statement/Sqlsrv/Exception.php';
            throw new SpamTrawler_Db_Statement_Sqlsrv_Exception(sqlsrv_errors());
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        if (!$values && (null !== $error = sqlsrv_errors())) {
            require_once 'SpamTrawler/Db/Statement/Sqlsrv/Exception.php';
            throw new SpamTrawler_Db_Statement_Sqlsrv_Exception($error);
        }
        ...
        switch ($style) {
            ...
            default:
                require_once 'SpamTrawler/Db/Statement/Sqlsrv/Exception.php';
                throw new SpamTrawler_Db_Statement_Sqlsrv_Exception("Invalid fetch mode '$style' specified");
                break;
        }
    ...
    public function getColumnMeta($column)
    {
        ...
        if (!$fields) {
            throw new SpamTrawler_Db_Statement_Sqlsrv_Exception('Column metadata can not be fetched');
        }

        if (!isset($fields[$column])) {
            throw new SpamTrawler_Db_Statement_Sqlsrv_Exception('Column index does not exist in statement');
        }
