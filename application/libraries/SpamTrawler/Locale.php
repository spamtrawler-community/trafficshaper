...
class SpamTrawler_Locale
{
     ...
     * @throws SpamTrawler_Locale_Exception When autodetection has been failed
     */
    ...
    public static function getDefault()
    {
        if ((self::$compatibilityMode === true) or (func_num_args() > 0)) {
            if (!self::$_breakChain) {
                ...
                trigger_error('You are running SpamTrawler_Locale in compatibility mode... please migrate your scripts', E_USER_NOTICE);
     ...
     *
     * @param  string|SpamTrawler_Locale $locale  Locale to set
     * @param  float              $quality The quality to set from 0 to 1
     * @throws SpamTrawler_Locale_Exception When a autolocale was given
     * @throws SpamTrawler_Locale_Exception When a unknown locale was given
     * @return void
     */
    public static function setDefault($locale, $quality = 1)
    {
        if (($locale === 'auto') or ($locale === 'root') or ($locale === 'default') or
            ...
            throw new SpamTrawler_Locale_Exception('Only full qualified locales can be used as default!');
        }

        if (($quality < 0.1) or ($quality > 100)) {
            require_once 'SpamTrawler/Locale/Exception.php';
            throw new SpamTrawler_Locale_Exception("Quality must be between 0.1 and 100");
        }
        ...
        if (isset(self::$_localeData[(string) $locale]) === true) {
            ...
            if (isset(self::$_localeData[$elocale[0]]) === true) {
                ...
                require_once 'SpamTrawler/Locale/Exception.php';
                throw new SpamTrawler_Locale_Exception("Unknown locale '" . (string) $locale . "' can not be set as default!");
            }
        }
    ...
    public static function getEnvironment()
    {
        ...
        require_once 'SpamTrawler/Locale/Data/Translation.php';
        ...
        foreach ($languages as $locale) {
            ...
            if ($language !== 'C') {
                ...
                $language = str_ireplace(
                    array_keys(SpamTrawler_Locale_Data_Translation::$languageTranslation),
                    array_values(SpamTrawler_Locale_Data_Translation::$languageTranslation),
                    (string) $language
                );

                $language = str_ireplace(
                    array_keys(SpamTrawler_Locale_Data_Translation::$regionTranslation),
                    array_values(SpamTrawler_Locale_Data_Translation::$regionTranslation),
                    $language
                );
     ...
     * Sets a new locale
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) New locale to set
     * @return void
     */
     ...
     *
     * @param  SpamTrawler_Locale $object Locale to check for equality
     * @return boolean
     */
    public function equals(SpamTrawler_Locale $object)
    {
     ...
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale|Language for which this informations should be returned
    ...
    public static function getTranslationList($path = null, $locale = null, $value = null)
    {
        ...
        $result = SpamTrawler_Locale_Data::getList($locale, $path, $value);
     ...
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale for language translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale for script translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale for country translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale for territory translation
     * @return array
     * @deprecated
     */
    ...
    public static function getTranslation($value = null, $path = null, $locale = null)
    {
        require_once 'SpamTrawler/Locale/Data.php';
        $locale = self::findLocale($locale);
        $result = SpamTrawler_Locale_Data::getContent($locale, $path, $value);
     ...
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale for language translation (defaults to $this locale)
     * @return array
     */
    public static function getQuestion($locale = null)
    {
        require_once 'SpamTrawler/Locale/Data.php';
        $locale            = self::findLocale($locale);
        $quest             = SpamTrawler_Locale_Data::getList($locale, 'question');
     ...
     *
     * @param  string|SpamTrawler_Locale $locale     Locale to check for
     ...
     *
     * @param string $locale
     * @throws SpamTrawler_Locale_Exception When the given locale is no locale or the autodetection fails
     * @return string
     */
    public static function findLocale($locale = null)
    {
        ...
        if ($locale === null) {
            $locale = new SpamTrawler_Locale();
        }

        if (!SpamTrawler_Locale::isLocale($locale, true, false)) {
            if (!SpamTrawler_Locale::isLocale($locale, false, false)) {
                $locale = SpamTrawler_Locale::getLocaleToTerritory($locale);

                if (empty($locale)) {
                    require_once 'SpamTrawler/Locale/Exception.php';
                    throw new SpamTrawler_Locale_Exception("The locale '$locale' is no known locale");
                }
            } else {
                $locale = new SpamTrawler_Locale($locale);
            }
        }
     ...
     *
     * @return SpamTrawler_Cache_Core The set cache
     */
    public static function getCache()
    {
        require_once 'SpamTrawler/Locale/Data.php';
        return SpamTrawler_Locale_Data::getCache();
    }

    /**
     * Sets a cache
     *
     * @param  SpamTrawler_Cache_Core $cache Cache to set
     * @return void
     */
    public static function setCache(SpamTrawler_Cache_Core $cache)
    {
        require_once 'SpamTrawler/Locale/Data.php';
        SpamTrawler_Locale_Data::setCache($cache);
    }
    ...
    {
        require_once 'SpamTrawler/Locale/Data.php';
        return SpamTrawler_Locale_Data::hasCache();
    }
    ...
    {
        require_once 'SpamTrawler/Locale/Data.php';
        SpamTrawler_Locale_Data::removeCache();
    }
    ...
    {
        require_once 'SpamTrawler/Locale/Data.php';
        SpamTrawler_Locale_Data::clearCache($tag);
    }
    ...
    {
        require_once 'SpamTrawler/Locale/Data.php';
        SpamTrawler_Locale_Data::disableCache($flag);
    }

    /**
     * Internal function, returns a single locale on detection
     *
     * @param  string|SpamTrawler_Locale $locale (Optional) Locale to work on
     * @param  boolean            $strict (Optional) Strict preparation
     * @throws SpamTrawler_Locale_Exception When no locale is set which is only possible when the class was wrong extended
     * @return string
     */
    private static function _prepareLocale($locale, $strict = false)
    {
        ...
        // This can only happen when someone extends SpamTrawler_Locale and erases the default
        if ($locale === null) {
            require_once 'SpamTrawler/Locale/Exception.php';
            throw new SpamTrawler_Locale_Exception('Autodetection of Locale has been failed!');
        }
     ...
     *
     * @param  string|SpamTrawler_Locale $locale Locale to work on
     * @return boolean
     */
