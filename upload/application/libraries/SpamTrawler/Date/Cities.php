 ...
 * @category   SpamTrawler
 * @package    SpamTrawler_Date
 * @subpackage SpamTrawler_Date_Cities
 * @copyright  Copyright (c) 2005-2014 SpamTrawler Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Date_Cities
{
    /**
     ...
     * @return array
     * @throws SpamTrawler_Date_Exception When city is unknown
     */
    public static function City($city, $horizon = false)
    {
        ...
        throw new SpamTrawler_Date_Exception('unknown city');
    }
