 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_NotEmpty extends SpamTrawler_Validate_Abstract
{
    const BOOLEAN       = 1;
    const INTEGER       = 2;
    const FLOAT         = 4;
     ...
     * @return SpamTrawler_Validate_NotEmpty
     */
    public function setType($type = null)
    {
        ...
        if (!is_int($type) || ($type < 0) || ($type > self::ALL)) {
            ...
            throw new SpamTrawler_Validate_Exception('Unknown type');
        }
