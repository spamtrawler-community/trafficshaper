 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_MimeType extends SpamTrawler_Validate_Abstract
{
    /**
    ...
    {
        if ($mimetype instanceof SpamTrawler_Config) {
        ...
        if (version_compare(PHP_VERSION, '5.3.0', '<')
            ...
            if (!empty($_ENV['MAGIC'])) {
                ...
                foreach ($this->_magicFiles as $file) {
                    ...
                    } catch (SpamTrawler_Validate_Exception $e) {
     ...
     *
     * @param  string $file
     * @throws SpamTrawler_Validate_Exception When finfo can not read the magicfile
     * @return SpamTrawler_Validate_File_MimeType Provides a fluent interface
     */
    public function setMagicFile($file)
    {
        if (empty($file)) {
            ...
            $this->_magicfile = null;
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception('Magicfile can not be set. There is no finfo extension installed');
        } else if (!is_file($file) || !is_readable($file)) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception('The given magicfile can not be read');
        } else {
            ...
            if (empty($this->_finfo)) {
                $this->_finfo = null;
                require_once 'SpamTrawler/Validate/Exception.php';
                throw new SpamTrawler_Validate_Exception(
     ...
     * specified by SpamTrawler_Validate_File_MimeType::_magicFiles
     *
     * @param  boolean $flag
     * @return SpamTrawler_Validate_File_MimeType Provides fluent interface
    ...
    /**
     * Accessor for SpamTrawler_Validate_File_MimeType::_magicFiles
     *
     * @return boolean
     * @see http://framework.zend.com/issues/browse/ZF-11784
     */
     ...
     * @return SpamTrawler_Validate_File_Extension Provides a fluent interface
     */
