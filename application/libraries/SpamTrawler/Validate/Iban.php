 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Iban extends SpamTrawler_Validate_Abstract
{
     ...
     *
     * @param string|SpamTrawler_Config|SpamTrawler_Locale $locale OPTIONAL
     */
    ...
    public function setLocale($locale = null)
    {
        if ($locale !== false) {
            ...
            if (strlen($locale) < 4) {
                ...
                throw new SpamTrawler_Validate_Exception('Region must be given for IBAN validation');
            }
        }
    ...
    public function isValid($value)
    {
        ...
        if (empty($this->_locale)) {
            ...
            $region = new SpamTrawler_Locale($this->_locale);
