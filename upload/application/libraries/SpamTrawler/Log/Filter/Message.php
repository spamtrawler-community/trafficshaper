 ...
 * @version    $Id$
 */
class SpamTrawler_Log_Filter_Message extends SpamTrawler_Log_Filter_Abstract
{
    /**
     * @var string
     */
    ...
    public function __construct($regexp)
    {
        if (@preg_match($regexp, '') === false) {
            ...
            throw new SpamTrawler_Log_Exception("Invalid regular expression '$regexp'");
        }
        $this->_regexp = $regexp;
    }

    /**
     * Create a new instance of SpamTrawler_Log_Filter_Message
     *
     * @param  array|SpamTrawler_Config $config
     * @return SpamTrawler_Log_Filter_Message
     */
