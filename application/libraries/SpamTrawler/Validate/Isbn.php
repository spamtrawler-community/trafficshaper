 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Isbn extends SpamTrawler_Validate_Abstract
{
    const AUTO    = 'auto';
    const ISBN10  = '10';
    const ISBN13  = '13';
     ...
     * @throws SpamTrawler_Validate_Exception When $options is not valid
     */
    public function __construct($options = array())
    {
        ...
        if (!is_array($options)) {
            ...
            throw new SpamTrawler_Validate_Exception('Invalid options provided.');
        }
     ...
     * @throws SpamTrawler_Validate_Exception When $separator is not valid
     * @return SpamTrawler_Validate_Isbn Provides a fluent interface
     */
    public function setSeparator($separator)
    {
        ...
        if (!in_array($separator, array('-', ' ', ''))) {
             ...
             */
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception('Invalid ISBN separator.');
        }
     ...
     *
     * @param  string $type
     * @throws SpamTrawler_Validate_Exception When $type is not valid
     * @return SpamTrawler_Validate_Isbn Provides a fluent interface
     */
    public function setType($type)
    {
        ...
        if (!in_array($type, array(self::AUTO, self::ISBN10, self::ISBN13))) {
             ...
             */
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception('Invalid ISBN type');
        }
