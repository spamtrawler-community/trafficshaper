 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_StringToLower implements SpamTrawler_Filter_Interface
{
    /**
     ...
     * @return SpamTrawler_Filter_StringToLower Provides a fluent interface
    ...
    public function setEncoding($encoding = null)
    {
        if ($encoding !== null) {
            if (!function_exists('mb_strtolower')) {
                ...
                throw new SpamTrawler_Filter_Exception('mbstring is required for this feature');
            }

            $encoding = (string) $encoding;
            if (!in_array(strtolower($encoding), array_map('strtolower', mb_list_encodings()))) {
                require_once 'SpamTrawler/Filter/Exception.php';
                throw new SpamTrawler_Filter_Exception("The given encoding '$encoding' is not supported by mbstring");
            }
        }
