...
/** SpamTrawler_Wildfire_Plugin_FirePhp_TableMessage */
require_once 'SpamTrawler/Wildfire/Plugin/FirePhp/TableMessage.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Profiler_Firebug extends SpamTrawler_Db_Profiler
{
    /**
     ...
     * @var SpamTrawler_Wildfire_Plugin_FirePhp_TableMessage
     */
    ...
    public function __construct($label = null)
    {
        $this->_label = $label;
        if(!$this->_label) {
            $this->_label = 'SpamTrawler_Db_Profiler_Firebug';
        }
    }
    ...
    public function setEnabled($enable)
    {
        ...
        if ($this->getEnabled()) {
            ...
            if (!$this->_message) {
                $this->_message = new SpamTrawler_Wildfire_Plugin_FirePhp_TableMessage($this->_label);
                ...
                SpamTrawler_Wildfire_Plugin_FirePhp::getInstance()->send($this->_message);
            }
