 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_RealPath implements SpamTrawler_Filter_Interface
{
    /**
     ...
     * Class constructor
     *
     * @param boolean|SpamTrawler_Config $options Options to set
     */
     ...
     *
     * @param boolean|SpamTrawler_Config $exists Path must exist
     * @return SpamTrawler_Filter_RealPath
     */
    public function setExists($exists)
    {
        if ($exists instanceof SpamTrawler_Config) {
