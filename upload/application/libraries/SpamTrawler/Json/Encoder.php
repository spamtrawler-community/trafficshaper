 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Json_Encoder
{
    /**
     ...
     * @param object $value
     * @return string
     * @throws SpamTrawler_Json_Exception If recursive checks are enabled and the object has been serialized previously
     */
    ...
    public static function encodeClass($className, $package = '')
    {
        ...
        if (! $cls->isInstantiable()) {
            require_once 'SpamTrawler/Json/Exception.php';
            throw new SpamTrawler_Json_Exception("$className must be instantiable");
        }
