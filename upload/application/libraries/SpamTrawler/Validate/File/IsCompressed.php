...
/**
 * @see SpamTrawler_Validate_File_MimeType
 */
require_once 'SpamTrawler/Validate/File/MimeType.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_IsCompressed extends SpamTrawler_Validate_File_MimeType
{
    /**
     ...
     *
     * @param string|array|SpamTrawler_Config $mimetype
     */
    ...
    protected function _throw($file, $errorType)
    {
        ...
        switch($errorType) {
            case SpamTrawler_Validate_File_MimeType::FALSE_TYPE :
                $errorType = self::FALSE_TYPE;
                break;
            case SpamTrawler_Validate_File_MimeType::NOT_DETECTED :
                $errorType = self::NOT_DETECTED;
                break;
            case SpamTrawler_Validate_File_MimeType::NOT_READABLE :
