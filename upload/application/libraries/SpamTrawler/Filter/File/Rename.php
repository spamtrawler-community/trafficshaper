 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_File_Rename implements SpamTrawler_Filter_Interface
{
    /**
     ...
     * Class constructor
     *
     * Options argument may be either a string, a SpamTrawler_Config object, or an array.
     * If an array or SpamTrawler_Config object, it accepts the following keys:
     ...
     * @return SpamTrawler_Filter_File_Rename
     */
    ...
    public function addFile($options)
    {
        if (is_string($options)) {
            ...
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception ('Invalid options to rename filter provided');
        }
    ...
    public function getNewName($value, $source = false)
    {
        ...
        if (file_exists($file['target'])) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception(sprintf("File '%s' could not be renamed. It already exists.", $value));
        }
    ...
    public function filter($value)
    {
        ...
        require_once 'SpamTrawler/Filter/Exception.php';
        throw new SpamTrawler_Filter_Exception(sprintf("File '%s' could not be renamed. An error occured while processing the file.", $value));
    }
