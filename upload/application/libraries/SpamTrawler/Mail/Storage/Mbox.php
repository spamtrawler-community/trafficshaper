 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Storage_Mbox extends SpamTrawler_Mail_Storage_Abstract
{
    /**
    ...
    public function __construct($params)
    {
        ...
        if (!isset($params->filename) /* || SpamTrawler_Loader::isReadable($params['filename']) */) {
            /**
             * @see SpamTrawler_Mail_Storage_Exception
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('no valid filename given in params');
        }
    ...
    protected function _openMboxFile($filename)
    {
        ...
        if (!$this->_fh) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('cannot open mbox file');
        }
        ...
        if (!$this->_isMboxFile($this->_fh, false)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Storage/Exception.php';
            throw new SpamTrawler_Mail_Storage_Exception('file is not a valid mbox format');
        }
    ...
    public function removeMessage($id)
    {
         ...
         */
        require_once 'SpamTrawler/Mail/Storage/Exception.php';
        throw new SpamTrawler_Mail_Storage_Exception('mbox is read-only');
    }
