 ...
 * @license    http://framework.SpamTrawler.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Log_Writer_Syslog extends SpamTrawler_Log_Writer_Abstract
{
    /**
     * Maps SpamTrawler_Log priorities to PHP's syslog priorities
     *
     * @var array
     */
    protected $_priorities = array(
        SpamTrawler_Log::EMERG  => LOG_EMERG,
        SpamTrawler_Log::ALERT  => LOG_ALERT,
        SpamTrawler_Log::CRIT   => LOG_CRIT,
        SpamTrawler_Log::ERR    => LOG_ERR,
        SpamTrawler_Log::WARN   => LOG_WARNING,
        SpamTrawler_Log::NOTICE => LOG_NOTICE,
        SpamTrawler_Log::INFO   => LOG_INFO,
        SpamTrawler_Log::DEBUG  => LOG_DEBUG,
    );
     ...
     * @var string
     */
    protected $_application = 'SpamTrawler_Log';
    ...
    /**
     * Create a new instance of SpamTrawler_Log_Writer_Syslog
     *
     * @param  array|SpamTrawler_Config $config
     * @return SpamTrawler_Log_Writer_Syslog
     */
     ...
     * @return SpamTrawler_Log_Writer_Syslog
     * @throws SpamTrawler_Log_Exception for invalid log facility
     */
    public function setFacility($facility)
    {
        ...
        if (!in_array($facility, $this->_validFacilities)) {
            ...
            throw new SpamTrawler_Log_Exception('Invalid log facility provided; please see http://php.net/openlog for a list of valid facility values');
        }
        ...
        if ('WIN' == strtoupper(substr(PHP_OS, 0, 3))
            ...
            require_once 'SpamTrawler/Log/Exception.php';
            throw new SpamTrawler_Log_Exception('Only LOG_USER is a valid log facility on Windows');
        }
    ...
    protected function _write($event)
    {
        ...
        if ($this->_formatter instanceof SpamTrawler_Log_Formatter_Interface) {
