...
class SpamTrawler_Locale_Math
{
    // support unit testing without using bcmath functions
    public static $_bcmathDisabled = false;

    public static $add   = array('SpamTrawler_Locale_Math', 'Add');
    public static $sub   = array('SpamTrawler_Locale_Math', 'Sub');
    public static $pow   = array('SpamTrawler_Locale_Math', 'Pow');
    public static $mul   = array('SpamTrawler_Locale_Math', 'Mul');
    public static $div   = array('SpamTrawler_Locale_Math', 'Div');
    public static $comp  = array('SpamTrawler_Locale_Math', 'Comp');
    public static $sqrt  = array('SpamTrawler_Locale_Math', 'Sqrt');
    public static $mod   = array('SpamTrawler_Locale_Math', 'Mod');
     ...
     *   round(0.36665, 4);
     * then try:
     *   SpamTrawler_Locale_Math::round('639.795', 2);
     */
    public static function round($op1, $precision = 0)
    {
        ...
        if ($triggerDigit >= '5') {
            ...
            if ($op1 > 0) {
                if (self::$_bcmathDisabled) {
                    return SpamTrawler_Locale_Math_PhpMath::Add($op1, $roundUp, $precision);
                }
                return self::Add($op1, $roundUp, $precision);
            } else {
                if (self::$_bcmathDisabled) {
                    return SpamTrawler_Locale_Math_PhpMath::Sub($op1, $roundUp, $precision);
                }
...
if (!extension_loaded('bcmath')
    ...
    require_once 'SpamTrawler/Locale/Math/PhpMath.php';
    SpamTrawler_Locale_Math_PhpMath::disable();
}
