 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Protocol_Pop3
{
    /**
    ...
    public function sendRequest($request)
    {
        ...
        if (!$result) {
             ...
             */
            require_once 'SpamTrawler/Mail/Protocol/Exception.php';
            throw new SpamTrawler_Mail_Protocol_Exception('send failed - connection closed?');
        }
    }
    ...
    public function readResponse($multiline = false)
    {
        ...
        if (!is_string($result)) {
             ...
             */
            require_once 'SpamTrawler/Mail/Protocol/Exception.php';
            throw new SpamTrawler_Mail_Protocol_Exception('read failed - connection closed?');
        }
        ...
        if ($status != '+OK') {
             ...
             */
            require_once 'SpamTrawler/Mail/Protocol/Exception.php';
            throw new SpamTrawler_Mail_Protocol_Exception('last request failed');
        }
    ...
    public function top($msgno, $lines = 0, $fallback = false)
    {
        if ($this->hasTop === false) {
            if ($fallback) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Protocol/Exception.php';
                throw new SpamTrawler_Mail_Protocol_Exception('top not supported and no fallback wanted');
            }
        }
        $this->hasTop = true;
