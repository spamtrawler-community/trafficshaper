 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Part_File extends SpamTrawler_Mail_Part
{
    ...
    public function __construct(array $params)
    {
        if (empty($params['file'])) {
            ...
            throw new SpamTrawler_Mail_Exception('no file given in params');
        }
        ...
        SpamTrawler_Mime_Decode::splitMessage($header, $this->_headers, $null);
        ...
        while (!feof($this->_fh) && ($endPos === null || $pos < $endPos)) {
            ...
            if ($line === false) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Exception.php';
                throw new SpamTrawler_Mail_Exception('error reading file');
            }
