 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_HtmlEntities implements SpamTrawler_Filter_Interface
{
    /**
     ...
     * @return SpamTrawler_Filter_HtmlEntities Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @return SpamTrawler_Filter_HtmlEntities
     */
    ...
    public function filter($value)
    {
        ...
        if (strlen((string) $value) && !strlen($filtered)) {
            if (!function_exists('iconv')) {
                ...
                throw new SpamTrawler_Filter_Exception('Encoding mismatch has resulted in htmlentities errors');
            }
