 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Callback extends SpamTrawler_Validate_Abstract
{
    /**
     * Invalid callback
     */
    ...
    public function __construct($callback = null)
    {
        ...
        if (null === ($initializedCallack = $this->getCallback())) {
            ...
            throw new SpamTrawler_Validate_Exception('No callback registered');
        }
    }
     ...
     * @throws SpamTrawler_Validate_Exception
     * @return SpamTrawler_Validate_Callback Provides a fluent interface
     */
