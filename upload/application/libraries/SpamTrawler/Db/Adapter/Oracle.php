...
/**
 * @see SpamTrawler_Db_Statement_Oracle
 */
require_once 'SpamTrawler/Db/Statement/Oracle.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Adapter_Oracle extends SpamTrawler_Db_Adapter_Abstract
{
    /**
    ...
    protected $_numericDataTypes = array(
        ...
        'BINARY_DOUBLE'      => SpamTrawler_Db::FLOAT_TYPE,
        'BINARY_FLOAT'       => SpamTrawler_Db::FLOAT_TYPE,
        'NUMBER'             => SpamTrawler_Db::FLOAT_TYPE,
    );
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'SpamTrawler_Db_Statement_Oracle';
     ...
     *
     * @return void
     * @throws SpamTrawler_Db_Adapter_Oracle_Exception
     */
    protected function _connect()
    {
        ...
        if (!extension_loaded('oci8')) {
            /**
             * @see SpamTrawler_Db_Adapter_Oracle_Exception
             */
            require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
            throw new SpamTrawler_Db_Adapter_Oracle_Exception('The OCI8 extension is required for this adapter but the extension is not loaded');
        }
        ...
        if (!$this->_connection) {
             ...
             */
            require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
            throw new SpamTrawler_Db_Adapter_Oracle_Exception(oci_error());
        }
    }
     ...
     * @return SpamTrawler_Db_Adapter_Oracle
     */
     ...
     * @return SpamTrawler_Db_Statement_Oracle
     */
    public function prepare($sql)
    {
        ...
        if ($stmt instanceof SpamTrawler_Db_Statement_Oracle) {
     ...
     *
     * @param string|array|SpamTrawler_Db_Expr $ident The identifier or expression.
    ...
    protected function _commit()
    {
        if (!oci_commit($this->_connection)) {
             ...
             */
            require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
            throw new SpamTrawler_Db_Adapter_Oracle_Exception(oci_error($this->_connection));
        }
        $this->_setExecuteMode(OCI_COMMIT_ON_SUCCESS);
    }
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            case SpamTrawler_Db::FETCH_BOUND: // bound to PHP variable
                 ...
                 */
                require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
                throw new SpamTrawler_Db_Adapter_Oracle_Exception('FETCH_BOUND is not supported yet');
                break;
            default:
                /**
                 * @see SpamTrawler_Db_Adapter_Oracle_Exception
                 */
                require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
                throw new SpamTrawler_Db_Adapter_Oracle_Exception("Invalid fetch mode '$mode' specified");
                break;
        }
    }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
             ...
             */
            require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
            throw new SpamTrawler_Db_Adapter_Oracle_Exception("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
             ...
             */
            require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
            throw new SpamTrawler_Db_Adapter_Oracle_Exception("LIMIT argument offset=$offset is not valid");
        }
    ...
    private function _setExecuteMode($mode)
    {
        switch($mode) {
            ...
            default:
                 ...
                 */
                require_once 'SpamTrawler/Db/Adapter/Oracle/Exception.php';
                throw new SpamTrawler_Db_Adapter_Oracle_Exception("Invalid execution mode '$mode' specified");
                break;
        }
    }
