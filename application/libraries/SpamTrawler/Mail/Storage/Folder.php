 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Storage_Folder implements RecursiveIterator
{
    /**
     * subfolders of folder array(localName => SpamTrawler_Mail_Storage_Folder folder)
     * @var array
     */
    protected $_folders;
     ...
     * @param array  $folders    init with given instances of SpamTrawler_Mail_Storage_Folder as subfolders
     */
    ...
    public function hasChildren()
    {
        ...
        return $current && $current instanceof SpamTrawler_Mail_Storage_Folder && !$current->isLeaf();
    }

    /**
     * implements RecursiveIterator::getChildren()
     *
     * @return SpamTrawler_Mail_Storage_Folder same as self::current()
     */
     ...
     *
     * @return SpamTrawler_Mail_Storage_Folder current folder
     */
     ...
     * @return SpamTrawler_Mail_Storage_Folder folder named $folder
    ...
    public function __get($name)
    {
        if (!isset($this->_folders[$name])) {
            ...
            throw new SpamTrawler_Mail_Storage_Exception("no subfolder named $name");
        }
     ...
     * @param SpamTrawler_Mail_Storage_Folder $folder instance for new subfolder
     * @return null
     */
    public function __set($name, SpamTrawler_Mail_Storage_Folder $folder)
    {
