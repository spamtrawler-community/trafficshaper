<div id="gridSpamHaus"></div>

        {literal}
        <script>
            $(document).ready(function () {
                var crudServiceBaseUrl = "{/literal}{$requestprotocol}://{$linkurl}Firewall/SpamHaus/Manage{literal}",
                ...
                $("#gridSpamHaus").kendoGrid({
                    ...
                    detailTemplate: kendo.template($("#commentTemplateSpamHaus").html()),
                    toolbar: ["create"],
                    columns: [
                        {
                            field: "url",
...
<!-- popup editor template -->
    <script id="popup_editorSpamHaus" type="text/x-kendo-template">
       <div id="errorsURLWhitelist">Shows Errors here!</div>
    </script>

        <script type="text/x-kendo-template" id="commentTemplateSpamHaus">
            <div class="row">
                <div>Comment:</div>
