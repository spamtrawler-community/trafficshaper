 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_Size extends SpamTrawler_Validate_Abstract
{
    /**#@+
     ...
     * @return SpamTrawler_Validate_File_Size Provides a fluent interface
     */
    public function setMin($min)
    {
        ...
        if (($max !== null) && ($min > $max)) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception("The minimum must be less than or equal to the maximum filesize, but $min >"
                                            . " $max");
        }
    ...
    public function setMax($max)
    {
        ...
        if (($min !== null) && ($max < $min)) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception("The maximum must be greater than or equal to the minimum filesize, but "
                                            . "$max < $min");
        }
     ...
     *
     * @param  int $size
     * @return SpamTrawler_Validate_File_Size
     */
