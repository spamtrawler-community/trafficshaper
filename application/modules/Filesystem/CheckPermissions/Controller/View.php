 ...
 */
class Filesystem_CheckPermissions_Controller_View extends SpamTrawler_BaseClasses_Modules_Controller
{
    ...
    public function find(){
        $aScanOptions = $_GET;
        $oScanner = new Filesystem_CheckPermissions_Model_Finder();
