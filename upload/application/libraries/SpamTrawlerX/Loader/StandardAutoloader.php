 ...
 *
 * @category   SpamTrawlerX
 * @package    SpamTrawlerX_Loader
 ...
 */
class SpamTrawlerX_Loader_StandardAutoloader implements SpamTrawlerX_Loader_SplAutoloader
{
    const NS_SEPARATOR     = '\\';
    ...
    {
        $this->registerPrefix('SpamTrawlerX', dirname(dirname(__FILE__)));
     ...
     * @return SpamTrawlerX_Loader_StandardAutoloader
     */
    public function setOptions($options)
    {
        if (!is_array($options) && !($options instanceof Traversable)) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException('Options must be either an array or Traversable');
        }
    ...
    public function registerNamespaces($namespaces)
    {
        if (!is_array($namespaces) && !$namespaces instanceof Traversable) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException('Namespace pairs must be either an array or Traversable');
        }
    ...
    public function registerPrefixes($prefixes)
    {
        if (!is_array($prefixes) && !$prefixes instanceof Traversable) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException('Prefix pairs must be either an array or Traversable');
        }
