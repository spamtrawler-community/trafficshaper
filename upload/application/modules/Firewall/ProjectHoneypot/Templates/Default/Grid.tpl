<div id="gridProjectHoneypot"></div>

        {literal}
        <script>
            $(document).ready(function () {
                var crudServiceBaseUrl = "{/literal}{$requestprotocol}://{$linkurl}Firewall/ProjectHoneypot/Manage{literal}",
                ...
                $("#gridProjectHoneypot").kendoGrid({
                    ...
                    detailTemplate: kendo.template($("#commentTemplateProjectHoneypot").html()),
                    toolbar: ["create"],
                    columns: [
                        {
                            field: "url",
...
<!-- popup editor template -->
    <script id="popup_editorProjectHoneypot" type="text/x-kendo-template">
       <div id="errorsURLWhitelist">Shows Errors here!</div>
    </script>

        <script type="text/x-kendo-template" id="commentTemplateProjectHoneypot">
            <div class="row">
                <div>Comment:</div>
