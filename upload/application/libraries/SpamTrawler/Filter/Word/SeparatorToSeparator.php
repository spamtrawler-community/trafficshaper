 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_Word_SeparatorToSeparator extends SpamTrawler_Filter_PregReplace
{
    ...
    protected function _separatorToSeparatorFilter($value)
    {
        if ($this->_searchSeparator == null) {
            ...
            throw new SpamTrawler_Filter_Exception('You must provide a search separator for this filter to work.');
        }
