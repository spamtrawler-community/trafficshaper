...
/**
 * @see SpamTrawler_Validate_File_Hash
 */
require_once 'SpamTrawler/Validate/File/Hash.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_Crc32 extends SpamTrawler_Validate_File_Hash
{
    /**
     ...
     *
     * @param  string|array|SpamTrawler_Config $options
     * @throws SpamTrawler_Validate_Exception
     * @return SpamTrawler_Validate_File_Crc32
     */
     ...
     * @return SpamTrawler_Validate_File_Hash Provides a fluent interface
     */
