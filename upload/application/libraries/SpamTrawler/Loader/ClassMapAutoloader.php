 ...
 */
class SpamTrawler_Loader_ClassMapAutoloader implements SpamTrawler_Loader_SplAutoloader
{
    /**
     ...
     * @return SpamTrawler_Loader_ClassMapAutoloader
     */
    ...
    public function registerAutoloadMap($map)
    {
        ...
        if (!is_array($map)) {
            ...
            throw new SpamTrawler_Loader_Exception_InvalidArgumentException('Map file provided does not return a map');
        }
    ...
    public function registerAutoloadMaps($locations)
    {
        if (!is_array($locations) && !($locations instanceof Traversable)) {
            require_once __DIR__ . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawler_Loader_Exception_InvalidArgumentException('Map list must be an array or implement Traversable');
        }
     ...
     * @return SpamTrawler_Loader_ClassMapAutoloader|mixed
     * @throws SpamTrawler_Loader_Exception_InvalidArgumentException for nonexistent locations
     */
    protected function loadMapFromFile($location)
    {
        if (!file_exists($location)) {
            require_once __DIR__ . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawler_Loader_Exception_InvalidArgumentException('Map file provided does not exist');
        }
