 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter implements SpamTrawler_Filter_Interface
{
     ...
     *
     * @param  SpamTrawler_Filter_Interface $filter
     * @param  string $placement
     * @return SpamTrawler_Filter Provides a fluent interface
     */
    public function addFilter(SpamTrawler_Filter_Interface $filter, $placement = self::CHAIN_APPEND)
    {
     ...
     * @return SpamTrawler_Filter Provides a fluent interface
     */
    public function appendFilter(SpamTrawler_Filter_Interface $filter)
    {
     ...
     * @return SpamTrawler_Filter Provides a fluent interface
     */
    public function prependFilter(SpamTrawler_Filter_Interface $filter)
    {
    ...
    /**
     * @deprecated
     * @see SpamTrawler_Filter::filterStatic()
     *
     * @param  mixed        $value
    ...
    {
        trigger_error(
            'SpamTrawler_Filter::get() is deprecated as of 1.9.0; please update your code to utilize SpamTrawler_Filter::filterStatic()',
            E_USER_NOTICE
        );
     ...
     * relative to the SpamTrawler_Filter namespace. This method automatically loads the class,
    ...
    public static function filterStatic($value, $classBaseName, array $args = array(), $namespaces = array())
    {
        ...
        $namespaces = array_merge((array) $namespaces, self::$_defaultNamespaces, array('SpamTrawler_Filter'));
        foreach ($namespaces as $namespace) {
            ...
            if (!class_exists($className, false)) {
                ...
                } catch (SpamTrawler_Exception $ze) {
                    continue;
                }
            }

            $class = new ReflectionClass($className);
            if ($class->implementsInterface('SpamTrawler_Filter_Interface')) {
        ...
        throw new SpamTrawler_Filter_Exception("Filter class not found from basename '$classBaseName'");
    }
}
