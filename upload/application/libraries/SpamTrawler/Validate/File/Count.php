 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_Count extends SpamTrawler_Validate_Abstract
{
    /**#@+
     ...
     *
     * @param  integer|array|SpamTrawler_Config $options Options for the adapter
     ...
     * @return SpamTrawler_Validate_File_Count Provides a fluent interface
     * @throws SpamTrawler_Validate_Exception When min is greater than max
     */
    public function setMin($min)
    {
        ...
        if (($this->_max !== null) && ($min > $this->_max)) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception("The minimum must be less than or equal to the maximum file count, but $min >"
                                            . " {$this->_max}");
        }
     ...
     * @throws SpamTrawler_Validate_Exception When max is smaller than min
     */
    public function setMax($max)
    {
        ...
        if (($this->_min !== null) && ($max < $this->_min)) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception("The maximum must be greater than or equal to the minimum file count, but "
                                            . "$max < {$this->_min}");
        }
