 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_PregReplace implements SpamTrawler_Filter_Interface
{
    /**
     * Pattern to match
     * @var mixed
     ...
     * @return SpamTrawler_Filter_PregReplace
     */
    ...
    public function filter($value)
    {
        if ($this->_matchPattern == null) {
            ...
            throw new SpamTrawler_Filter_Exception(get_class($this) . ' does not have a valid MatchPattern set.');
        }
