<div id="gridCleanTalk"></div>

        {literal}
        <script>
            $(document).ready(function () {
                var crudServiceBaseUrl = "{/literal}{$requestprotocol}://{$linkurl}Firewall/CleanTalk/Manage{literal}",
                ...
                $("#gridCleanTalk").kendoGrid({
                    ...
                    detailTemplate: kendo.template($("#commentTemplateCleanTalk").html()),
                    toolbar: ["create"],
                    columns: [
                        {
                            field: "url",
...
<!-- popup editor template -->
    <script id="popup_editorCleanTalk" type="text/x-kendo-template">
       <div id="errorsURLWhitelist">Shows Errors here!</div>
    </script>

        <script type="text/x-kendo-template" id="commentTemplateCleanTalk">
            <div class="row">
                <div>Comment:</div>
