 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_StripTags implements SpamTrawler_Filter_Interface
{
    /**
     * Unique ID prefix used for allowing comments
     */
    const UNIQUE_ID_PREFIX = '__SpamTrawler_Filter_StripTags__';
     ...
     * @return SpamTrawler_Filter_StripTags Provides a fluent interface
     */
