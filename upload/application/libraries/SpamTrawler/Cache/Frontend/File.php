 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Cache_Frontend_File extends SpamTrawler_Cache_Core
{
     ...
     * - SpamTrawler_Cache_Frontend_File::MODE_AND or SpamTrawler_Cache_Frontend_File::MODE_OR
    ...
    public function __construct(array $options = array())
    {
        ...
        if (!isset($this->_specificOptions['master_files'])) {
            SpamTrawler_Cache::throwException('master_files option must be set');
        }
    }
    ...
    public function setMasterFiles(array $masterFiles)
    {
        ...
        foreach ($masterFiles as $masterFile) {
            ...
            if (!$this->_specificOptions['ignore_missing_master_files'] && !$mtime) {
                SpamTrawler_Cache::throwException('Unable to read master_file : ' . $masterFile);
            }
