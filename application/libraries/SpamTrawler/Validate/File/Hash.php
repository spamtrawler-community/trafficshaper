 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_Hash extends SpamTrawler_Validate_Abstract
{
    /**
    ...
    public function addHash($options)
    {
        if (is_string($options)) {
            ...
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception("False parameter given");
        }
        ...
        if (!in_array($algorithm, $known)) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception("Unknown algorithm '{$algorithm}'");
        }
