...
/**
 * @see SpamTrawler_Validate_File_Exists
 */
require_once 'SpamTrawler/Validate/File/Exists.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_NotExists extends SpamTrawler_Validate_File_Exists
{
    /**
