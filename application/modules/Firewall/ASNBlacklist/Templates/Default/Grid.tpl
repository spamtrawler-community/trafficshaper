...
<div class="row">
    ...
    <div class="small-2 columns">
        <select id="column_asnblacklist" class="radius">
            <option value="asn">ASN</option>
            <option value="comment">Comment</option>
        </select>
    </div>
    <div class="small-2 columns">
        <select id="operator_asnblacklist" class="radius">
    ...
    <div class="small-2 columns">
        <input type="button" id="btnFilter_asnblacklist" class="k-button" value="Filter">
        <input type="button" id="btnReset_asnblacklist" class="k-button" value="Reset">
    </div>
</div>
        <div id="gridASNBlacklist"></div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#gridASNBlacklist").kendoGrid({
                    ...
                    detailTemplate: kendo.template($("#commentTemplateASNBlacklist").html()),
                    toolbar: ["create"],
                    columns: [
                        {
                            field: "asn",
                ...
                $("#btnFilter_asnblacklist").on("click", function(e) {
                    var ds = $("#gridASNBlacklist").data("kendoGrid").dataSource;
                    ds.filter([{
                        "field": $("#column_asnblacklist").val(),
                        "operator": $("#operator_asnblacklist").val(),
                        "value": $("#query_asnblacklist").val()}
                    ]);
                });

                $("#btnReset_asnblacklist").on("click", function(e) {
                    $("#query_asnblacklist").val('');
                    var ds = $("#gridASNBlacklist").data("kendoGrid").dataSource;
                    ds.filter([]);
                });
            });
...
<!-- popup editor template -->
    <script id="popup_editorASNBlacklist" type="text/x-kendo-template">
       <div id="errorsASNBlacklist">Shows Errors here!</div>
    </script>

        <script type="text/x-kendo-template" id="commentTemplateASNBlacklist">
            <div class="row">
                <div>Comment:</div>
