...
/** SpamTrawler_Loader_PluginLoader_Interface */
require_once 'SpamTrawler/Loader/PluginLoader/Interface.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Loader_PluginLoader implements SpamTrawler_Loader_PluginLoader_Interface
{
    /**
    ...
    public function addPrefixPath($prefix, $path)
    {
        if (!is_string($prefix) || !is_string($path)) {
            require_once 'SpamTrawler/Loader/PluginLoader/Exception.php';
            throw new SpamTrawler_Loader_PluginLoader_Exception('SpamTrawler_Loader_PluginLoader::addPrefixPath() method only takes strings for prefix and path.');
        }
    ...
    public function removePrefixPath($prefix, $path = null)
    {
        ...
        if (!isset($registry[$prefix])) {
            require_once 'SpamTrawler/Loader/PluginLoader/Exception.php';
            throw new SpamTrawler_Loader_PluginLoader_Exception('Prefix ' . $prefix . ' was not found in the PluginLoader.');
        }
        ...
        if ($path != null) {
            ...
            if (false === $pos) {
                require_once 'SpamTrawler/Loader/PluginLoader/Exception.php';
                throw new SpamTrawler_Loader_PluginLoader_Exception('Prefix ' . $prefix . ' / Path ' . $path . ' was not found in the PluginLoader.');
            }
     ...
     * @throws SpamTrawler_Loader_Exception if class not found
     */
    public function load($name, $throwExceptions = true)
    {
        ...
        foreach ($registry as $prefix => $paths) {
            ...
            foreach ($paths as $path) {
                ...
                if (SpamTrawler_Loader::isReadable($loadFile)) {
        ...
        if (!$found) {
            ...
            require_once 'SpamTrawler/Loader/PluginLoader/Exception.php';
            throw new SpamTrawler_Loader_PluginLoader_Exception($message);
       }
     ...
     * @param  string $file
     * @return void
     * @throws SpamTrawler_Loader_PluginLoader_Exception if file is not writeable or path does not exist
     */
    public static function setIncludeFileCache($file)
    {
        ...
        if (!file_exists($file) && !file_exists(dirname($file))) {
            require_once 'SpamTrawler/Loader/PluginLoader/Exception.php';
            throw new SpamTrawler_Loader_PluginLoader_Exception('Specified file does not exist and/or directory does not exist (' . $file . ')');
        }
        if (file_exists($file) && !is_writable($file)) {
            require_once 'SpamTrawler/Loader/PluginLoader/Exception.php';
            throw new SpamTrawler_Loader_PluginLoader_Exception('Specified file is not writeable (' . $file . ')');
        }
