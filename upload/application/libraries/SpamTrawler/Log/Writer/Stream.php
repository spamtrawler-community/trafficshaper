 ...
 * @version    $Id$
 */
class SpamTrawler_Log_Writer_Stream extends SpamTrawler_Log_Writer_Abstract
{
    /**
    ...
    public function __construct($streamOrUrl, $mode = null)
    {
        ...
        if (is_resource($streamOrUrl)) {
            if (get_resource_type($streamOrUrl) != 'stream') {
                ...
                throw new SpamTrawler_Log_Exception('Resource is not a stream');
            }

            if ($mode != 'a') {
                require_once 'SpamTrawler/Log/Exception.php';
                throw new SpamTrawler_Log_Exception('Mode cannot be changed on existing streams');
            }
            ...
            if (! $this->_stream = @fopen($streamOrUrl, $mode, false)) {
                ...
                throw new SpamTrawler_Log_Exception($msg);
            }
        }
    ...
    /**
     * Create a new instance of SpamTrawler_Log_Writer_Stream
     *
     * @param  array|SpamTrawler_Config $config
     * @return SpamTrawler_Log_Writer_Stream
     */
    ...
    protected function _write($event)
    {
        ...
        if (false === @fwrite($this->_stream, $line)) {
            require_once 'SpamTrawler/Log/Exception.php';
            throw new SpamTrawler_Log_Exception("Unable to write to stream");
        }
    }
}
