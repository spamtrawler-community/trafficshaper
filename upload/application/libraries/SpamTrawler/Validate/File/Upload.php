 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_Upload extends SpamTrawler_Validate_Abstract
{
    /**@#+
     ...
     *
     * The array $files must be given in syntax of SpamTrawler_File_Transfer to be checked
     * If no files are given the $_FILES array will be used automatically.
     * NOTE: This validator will only work with HTTP POST uploads!
     *
     * @param array|SpamTrawler_Config $files Array of files in syntax of SpamTrawler_File_Transfer
     */
    public function __construct($files = array())
    {
        if ($files instanceof SpamTrawler_Config) {
            $files = $files->toArray();
        }
     ...
     * @return array
     * @throws SpamTrawler_Validate_Exception If file is not found
     */
    public function getFiles($file = null)
    {
        if ($file !== null) {
            ...
            if (count($return) === 0) {
                ...
                throw new SpamTrawler_Validate_Exception("The file '$file' was not found");
            }
     ...
     *
     * @param  array $files The files to check in syntax of SpamTrawler_File_Transfer
     * @return SpamTrawler_Validate_File_Upload Provides a fluent interface
     */
