 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Barcode extends SpamTrawler_Validate_Abstract
{
     ...
     * Barcode adapter
     *
     * @var SpamTrawler_Validate_Barcode_BarcodeAdapter
     */
    protected $_adapter;
     ...
     *
     * @param  string|SpamTrawler_Config|
     *         SpamTrawler_Validate_Barcode_BarcodeAdapter $adapter Barcode adapter to use
    ...
    public function __construct($adapter)
    {
        ...
        if (is_array($adapter)) {
            ...
            if (array_key_exists('adapter', $adapter)) {
                ...
                throw new SpamTrawler_Validate_Exception("Missing option 'adapter'");
            }
        }
     ...
     *
     * @return SpamTrawler_Validate_Barcode_BarcodeAdapter
     */
     ...
     *
     * @param  string|SpamTrawler_Validate_Barcode $adapter Barcode adapter to use
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        require_once 'SpamTrawler/Loader.php';
        if (SpamTrawler_Loader::isReadable('SpamTrawler/Validate/Barcode/' . $adapter. '.php')) {
            $adapter = 'SpamTrawler_Validate_Barcode_' . $adapter;
        }
        ...
        if (!$this->_adapter instanceof SpamTrawler_Validate_Barcode_AdapterInterface) {
            require_once 'SpamTrawler/Validate/Exception.php';
            throw new SpamTrawler_Validate_Exception(
                "Adapter " . $adapter . " does not implement SpamTrawler_Validate_Barcode_AdapterInterface"
            );
        }
     ...
     * @return SpamTrawler_Validate_Barcode
     */
