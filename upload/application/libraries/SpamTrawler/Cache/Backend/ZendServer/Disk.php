 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Cache_Backend_SpamTrawlerServer_Disk extends SpamTrawler_Cache_Backend_SpamTrawlerServer implements SpamTrawler_Cache_Backend_Interface
{
    /**
     * Constructor
     *
    ...
    public function __construct(array $options = array())
    {
        if (!function_exists('zend_disk_cache_store')) {
            SpamTrawler_Cache::throwException('SpamTrawler_Cache_SpamTrawlerServer_Disk backend has to be used within SpamTrawler Server environment.');
        }
