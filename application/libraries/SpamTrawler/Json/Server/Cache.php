...
/** SpamTrawler_Server_Cache */
require_once 'SpamTrawler/Server/Cache.php';

/**
 * SpamTrawler_Json_Server_Cache: cache SpamTrawler_Json_Server server definition and SMD
 *
 * @category   SpamTrawler
 * @package    SpamTrawler_Json
 * @subpackage Server
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Json_Server_Cache extends SpamTrawler_Server_Cache
{
    /**
     ...
     * @param  SpamTrawler_Json_Server $server
     * @return boolean
     */
    public static function saveSmd($filename, SpamTrawler_Json_Server $server)
    {
