<div class="row">
    <div class="small-12 columns">
            <h3>Unblocked Visitors</h3>
    </div>
        <div class="small-3 columns">
            <input type="text" id="query_unblocked" class="radius" value="" placeholder="Search">
        </div>
        <div class="small-3 columns">
        ...
        <div class="small-12 columns" style="min-height: 550px; padding-bottom: 50px;">
            <span id="visitorsunblocked"></span>
        </div>
...
<script>
    $(document).ready(function () {
        var crudServiceBaseUrl = "{/literal}{$requestprotocol}://{$linkurl}Feeds/Visitors/ManageUnblocked{literal}",
        ...
        $("#visitorsunblocked").kendoGrid({
            ...
            detailTemplate: kendo.template($("#UnblockedVisitorsDetailsTemplate").html()),
            height: 600,
            columns: [
                {
                    field: "country_code",
        ...
        $("#btnFilter_Unblocked").on("click", function(e) {
            var ds = $("#visitorsunblocked").data("kendoGrid").dataSource;
            ds.filter([{
                "field": $("#column_unblocked").val(),
                "operator": $("#operator_unblocked").val(),
                "value": $("#query_unblocked").val()}
            ]);
        });

        $("#btnReset_Unblocked").on("click", function(e) {
            $("#query_unblocked").val('');
            var ds = $("#visitorsunblocked").data("kendoGrid").dataSource;
            ds.filter([]);
        });
    ...
    /*
     var UnblockedGrid = $("#visitorsunblocked").data("kendoGrid");
     var dataSource = UnblockedGrid.dataSource;
     var totalRecords = dataSource.total();
     alert(totalRecords);
     if(totalRecords == 0){
     $("#visitorsunblockedgridholder").hide();
     }
     */
</script>
...
<script type="text/x-kendo-template" id="UnblockedVisitorsDetailsTemplate">
    <div class="panel">
    ...
    <div class="row griddetailrow">
        ...
        <div class="small-2 columns text-right">
            <span class="radius alert label label-blacklist" style="visibility: hidden;">Blacklist</span>
