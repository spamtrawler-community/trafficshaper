 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_Between extends SpamTrawler_Validate_Abstract
{
    /**
    ...
    public function __construct($options)
    {
        ...
        if (!array_key_exists('min', $options) || !array_key_exists('max', $options)) {
            ...
            throw new SpamTrawler_Validate_Exception("Missing option. 'min' and 'max' has to be given");
        }
     ...
     *
     * @param  mixed $min
     * @return SpamTrawler_Validate_Between Provides a fluent interface
     */
