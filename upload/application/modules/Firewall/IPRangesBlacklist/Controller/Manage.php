...
class Firewall_IPRangesBlacklist_Controller_Manage extends SpamTrawler_BaseClasses_Modules_Controller
{
    ...
    public function get()
    {
        $oManage = $oManage = new Firewall_IPRangesBlacklist_Model_Manage;
        $oManage->get();
    }
    ...
    public function create()
    {
        ...
        $oManage = new Firewall_IPRangesBlacklist_Model_Manage(json_decode($_POST['models']));
    ...
    {
        $oManage = new Firewall_IPRangesBlacklist_Model_Manage();
    ...
    {
        $oManage = new Firewall_IPRangesBlacklist_Model_Manage(NULL);
        $oManage->deleteCache();
    }
}
