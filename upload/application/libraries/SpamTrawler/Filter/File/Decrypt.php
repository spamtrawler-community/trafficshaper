...
/**
 * @see SpamTrawler_Filter_Decrypt
 */
require_once 'SpamTrawler/Filter/Decrypt.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_File_Decrypt extends SpamTrawler_Filter_Decrypt
{
    /**
     * New filename to set
     *
     ...
     * @return SpamTrawler_Filter_File_Encryt
     */
    ...
    public function filter($value)
    {
        ...
        if (file_exists($this->_filename) and !is_writable($this->_filename)) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception("File '{$this->_filename}' is not writable");
        }
        ...
        if (!$result) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception("Problem while writing file '{$this->_filename}'");
        }
