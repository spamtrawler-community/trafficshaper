 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Cache_Backend_Libmemcached extends SpamTrawler_Cache_Backend implements SpamTrawler_Cache_Backend_ExtendedInterface
{
    /**
     ...
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_LIBMEMCACHED_BACKEND = 'SpamTrawler_Cache_Backend_Libmemcached::clean() : tags are unsupported by the Libmemcached backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_LIBMEMCACHED_BACKEND =  'SpamTrawler_Cache_Backend_Libmemcached::save() : tags are unsupported by the Libmemcached backend';
    ...
    public function __construct(array $options = array())
    {
        if (!extension_loaded('memcached')) {
            SpamTrawler_Cache::throwException('The memcached extension must be loaded for using this backend !');
        }
    ...
    public function clean($mode = SpamTrawler_Cache::CLEANING_MODE_ALL, $tags = array())
    {
        switch ($mode) {
            ...
            case SpamTrawler_Cache::CLEANING_MODE_OLD:
                $this->_log("SpamTrawler_Cache_Backend_Libmemcached::clean() : CLEANING_MODE_OLD is unsupported by the Libmemcached backend");
                break;
    ...
    {
        $this->_log("SpamTrawler_Cache_Backend_Libmemcached::save() : getting the list of cache ids is unsupported by the Libmemcached backend");
        return array();
    }
    ...
    public function getFillingPercentage()
    {
        ...
        if ($memSize === null || $memUsed === null) {
            SpamTrawler_Cache::throwException('Can\'t get filling percentage');
        }
