...
/**
 * @see SpamTrawler_Db_Statement
 */
require_once 'SpamTrawler/Db/Statement.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Db_Statement_Oracle extends SpamTrawler_Db_Statement
{
     ...
     * @param string $sql
     * @return void
     * @throws SpamTrawler_Db_Statement_Oracle_Exception
     */
    protected function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            /**
             * @see SpamTrawler_Db_Statement_Oracle_Exception
             */
            require_once 'SpamTrawler/Db/Statement/Oracle/Exception.php';
            throw new SpamTrawler_Db_Statement_Oracle_Exception(oci_error($connection));
        }
    }
    ...
    protected function _bindParam($parameter, &$variable, $type = null, $length = null, $options = null)
    {
        ...
        if ($retval === false) {
             ...
             */
            require_once 'SpamTrawler/Db/Statement/Oracle/Exception.php';
            throw new SpamTrawler_Db_Statement_Oracle_Exception(oci_error($this->_stmt));
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                require_once 'SpamTrawler/Db/Statement/Oracle/Exception.php';
                throw new SpamTrawler_Db_Statement_Oracle_Exception(
                    array(
                        'code'    => 'HYC00',
        ...
        if (! $row && $error = oci_error($this->_stmt)) {
             ...
             */
            require_once 'SpamTrawler/Db/Statement/Oracle/Exception.php';
            throw new SpamTrawler_Db_Statement_Oracle_Exception($error);
        }
    ...
    public function fetchAll($style = null, $col = 0)
    {
        ...
        switch ($style) {
            ...
            case SpamTrawler_Db::FETCH_OBJ:
                break;
            case SpamTrawler_Db::FETCH_COLUMN:
        ...
        $result = Array();
        if ($flags != OCI_FETCHSTATEMENT_BY_ROW) { /* not SpamTrawler_Db::FETCH_OBJ */
            ...
            if ($style == SpamTrawler_Db::FETCH_COLUMN) {
                $result = $result[$col];
            }
