 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Mail_Transport_Sendmail extends SpamTrawler_Mail_Transport_Abstract
{
    /**
     * Subject
     * @var string
     ...
     * Constructor.
     *
     * @param  string|array|SpamTrawler_Config $parameters OPTIONAL (Default: null)
     * @return void
     */
    public function __construct($parameters = null)
    {
        if ($parameters instanceof SpamTrawler_Config) {
     ...
     * @access public
     * @return void
     * @throws SpamTrawler_Mail_Transport_Exception if parameters is set
     *         but not a string
     * @throws SpamTrawler_Mail_Transport_Exception on mail() failure
     */
    public function _sendMail()
    {
        if ($this->parameters === null) {
            ...
            if(!is_string($this->parameters)) {
                ...
                throw new SpamTrawler_Mail_Transport_Exception(
        ...
        if ($this->_errstr !== null || !$result) {
             ...
             */
            require_once 'SpamTrawler/Mail/Transport/Exception.php';
            throw new SpamTrawler_Mail_Transport_Exception('Unable to send mail. ' . $this->_errstr);
        }
    }
     ...
     * @param   array $headers
     * @return  void
     * @throws  SpamTrawler_Mail_Transport_Exception
     */
    protected function _prepareHeaders($headers)
    {
        ...
        if (0 === strpos(PHP_OS, 'WIN')) {
            ...
            if (empty($this->recipients)) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Transport/Exception.php';
                throw new SpamTrawler_Mail_Transport_Exception('Missing To addresses');
            }
        } else {
            ...
            if (!isset($headers['To'])) {
                 ...
                 */
                require_once 'SpamTrawler/Mail/Transport/Exception.php';
                throw new SpamTrawler_Mail_Transport_Exception('Missing To header');
            }
