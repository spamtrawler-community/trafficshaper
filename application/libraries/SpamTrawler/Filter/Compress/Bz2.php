 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_Compress_Bz2 extends SpamTrawler_Filter_Compress_CompressAbstract
{
    /**
     * Compression Options
     * array(
     ...
     * Class constructor
     *
     * @param array|SpamTrawler_Config $options (Optional) Options to set
     */
    public function __construct($options = null)
    {
        if (!extension_loaded('bz2')) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception('This filter needs the bz2 extension');
        }
     ...
     *
     * @param integer $level
     * @return SpamTrawler_Filter_Compress_Bz2
     */
    public function setBlocksize($blocksize)
    {
        if (($blocksize < 0) || ($blocksize > 9)) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception('Blocksize must be between 0 and 9');
        }
    ...
    public function decompress($content)
    {
        ...
        if (@file_exists($archive)) {
            ...
            if (!$file) {
                require_once 'SpamTrawler/Filter/Exception.php';
                throw new SpamTrawler_Filter_Exception("Error opening the archive '" . $content . "'");
            }
        ...
        if (is_int($compressed)) {
            require_once 'SpamTrawler/Filter/Exception.php';
            throw new SpamTrawler_Filter_Exception('Error during decompression');
        }
