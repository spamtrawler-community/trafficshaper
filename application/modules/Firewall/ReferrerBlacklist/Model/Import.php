...
class Firewall_ReferrerBlacklist_Model_Import extends Firewall_Abstract_Import_Import {
    protected $dbTableName = 'blacklist_referrer';
    protected $sCheckValueDbField = 'referrer';
    ...
    protected function validate($iLine){
        ...
        } elseif($this->sFilterMode == 'exact'){
            if( !filter_var($this->sCheckValue, FILTER_VALIDATE_URL)){
                $this->aErrors[] = '[Line: ' . $iLine . '] Invalid Referrer';
                return false;
            }
        }
        return true;
