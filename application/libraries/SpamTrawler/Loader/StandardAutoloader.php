 ...
 */
class SpamTrawler_Loader_StandardAutoloader implements SpamTrawler_Loader_SplAutoloader
{
    const NS_SEPARATOR     = '\\';
     ...
     * array(
     *     'namespaces' => array(
     *         'SpamTrawler'     => '/path/to/SpamTrawler/library',
     ...
     * @return SpamTrawler_Loader_StandardAutoloader
     */
    public function setOptions($options)
    {
        if (!is_array($options) && !($options instanceof Traversable)) {
            require_once __DIR__ . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawler_Loader_Exception_InvalidArgumentException('Options must be either an array or Traversable');
        }
        ...
        foreach ($options as $type => $pairs) {
            switch ($type) {
                case self::AUTOREGISTER_ZF:
                    if ($pairs) {
                        $this->registerPrefix('SpamTrawler', dirname(__DIR__));
                    }
                    break;
                case self::LOAD_NS:
    ...
    public function registerNamespaces($namespaces)
    {
        if (!is_array($namespaces) && !$namespaces instanceof Traversable) {
            require_once __DIR__ . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawler_Loader_Exception_InvalidArgumentException('Namespace pairs must be either an array or Traversable');
        }
    ...
    public function registerPrefixes($prefixes)
    {
        if (!is_array($prefixes) && !$prefixes instanceof Traversable) {
            require_once __DIR__ . '/Exception/InvalidArgumentException.php';
            throw new SpamTrawler_Loader_Exception_InvalidArgumentException('Prefix pairs must be either an array or Traversable');
        }
