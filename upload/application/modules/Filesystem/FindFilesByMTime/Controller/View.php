 ...
 */
class Filesystem_FindFilesByMTime_Controller_View extends SpamTrawler_BaseClasses_Modules_Controller
{
    ...
    public function find(){
        $aScanOptions = $_GET;
        $oScanner = new Filesystem_FindFilesByMTime_Model_Finder();
