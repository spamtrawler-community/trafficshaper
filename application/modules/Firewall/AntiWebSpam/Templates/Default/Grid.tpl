<div id="gridAntiWebSpam"></div>

        {literal}
        <script>
            $(document).ready(function () {
                var crudServiceBaseUrl = "{/literal}{$requestprotocol}://{$linkurl}Firewall/AntiWebSpam/Manage{literal}",
                ...
                $("#gridAntiWebSpam").kendoGrid({
                    ...
                    detailTemplate: kendo.template($("#commentTemplateAntiWebSpam").html()),
                    toolbar: ["create"],
                    columns: [
                        {
                            field: "url",
...
<!-- popup editor template -->
    <script id="popup_editorAntiWebSpam" type="text/x-kendo-template">
       <div id="errorsURLWhitelist">Shows Errors here!</div>
    </script>

        <script type="text/x-kendo-template" id="commentTemplateAntiWebSpam">
            <div class="row">
                <div>Comment:</div>
