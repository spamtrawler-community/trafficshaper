...
if (class_exists('SpamTrawlerX_Loader_AutoloaderFactory')) return;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class SpamTrawlerX_Loader_AutoloaderFactory
{
    const STANDARD_AUTOLOADER = 'SpamTrawlerX_Loader_StandardAutoloader';
    ...
    /**
     * @var SpamTrawlerX_Loader_StandardAutoloader StandardAutoloader instance for resolving 
     ...
     * loaded).
     *
     * @param  array|Traversable $options (optional) options to use. Defaults to SpamTrawlerX_Loader_StandardAutoloader
     * @return void
     * @throws SpamTrawlerX_Loader_Exception_InvalidArgumentException for invalid options
     * @throws SpamTrawlerX_Loader_Exception_InvalidArgumentException for unloadable autoloader classes
     */
    public static function factory($options = null)
    {
        ...
        if (!is_array($options) && !($options instanceof Traversable)) {
            ...
            throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException(
        ...
        foreach ($options as $class => $options) {
            if (!isset(self::$loaders[$class])) {
                ...
                if (!class_exists($class) && !$autoloader->autoload($class)) {
                    require_once 'Exception/InvalidArgumentException.php';
                    throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException(sprintf(
                ...
                if (version_compare(PHP_VERSION, '5.3.7', '>=')) {
                        if (!is_subclass_of($class, 'SpamTrawlerX_Loader_SplAutoloader')) {
                        require_once 'Exception/InvalidArgumentException.php';
                        throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException(sprintf(
     ...
     *
     * @param string $class
     * @return SpamTrawlerX_Loader_SplAutoloader
     * @throws SpamTrawlerX_Loader_Exception_InvalidArgumentException for non-registered class
     */
    public static function getRegisteredAutoloader($class)
    {
        if (!isset(self::$loaders[$class])) {
            require_once 'Exception/InvalidArgumentException.php';
            throw new SpamTrawlerX_Loader_Exception_InvalidArgumentException(sprintf('Autoloader class "%s" not loaded', $class));
        }
     ...
     * allow resolving autoloaders not under the "Zend" or "SpamTrawlerX" namespaces.
     * 
     * @return SpamTrawlerX_Loader_SplAutoloader
     */
    protected static function getStandardAutoloader()
    {
        ...
        $loader = new SpamTrawlerX_Loader_StandardAutoloader();
