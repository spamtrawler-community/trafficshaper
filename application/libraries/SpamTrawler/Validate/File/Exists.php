 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Validate_File_Exists extends SpamTrawler_Validate_Abstract
{
    /**
     ...
     *
     * @param  string|array|SpamTrawler_Config $directory
     * @throws SpamTrawler_Validate_Exception
     */
    public function __construct($directory = array())
    {
        if ($directory instanceof SpamTrawler_Config) {
