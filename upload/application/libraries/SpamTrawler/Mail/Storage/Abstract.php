 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class SpamTrawler_Mail_Storage_Abstract implements Countable, ArrayAccess, SeekableIterator
{
    /**
     ...
     * @var string
     */
    protected $_messageClass = 'SpamTrawler_Mail_Message';
    ...
    public function __get($var)
    {
        ...
        throw new SpamTrawler_Mail_Storage_Exception($var . ' not found');
    }
     ...
     */
      ...
      *
      * @param    int $id
      * @return   SpamTrawler_Mail_Message message object
      */
     ...
     public function offsetSet($id, $value)
     {
         ...
         */
        require_once 'SpamTrawler/Mail/Storage/Exception.php';
        throw new SpamTrawler_Mail_Storage_Exception('cannot write mail messages via array access');
     }
      ...
      * Iterator::current()
      *
      * @return   SpamTrawler_Mail_Message current message
      */
