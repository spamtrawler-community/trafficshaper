...
class Firewall_IPRangesBlacklist_Controller_Export extends SpamTrawler_BaseClasses_Modules_Controller {
    private $aConfig = array(
        'dbTableName' => 'blacklist_ipranges',
    ...
    {
        $oImport = new Firewall_IPRangesBlacklist_Model_Export($this->aConfig);
