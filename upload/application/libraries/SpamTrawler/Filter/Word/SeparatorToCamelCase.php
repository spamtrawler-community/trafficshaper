 ...
 */
require_once 'SpamTrawler/Filter/Word/Separator/Abstract.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class SpamTrawler_Filter_Word_SeparatorToCamelCase extends SpamTrawler_Filter_Word_Separator_Abstract
{
    ...
    public function filter($value)
    {
        ...
        if (self::isUnicodeSupportEnabled()) {
            ...
            parent::setReplacement(array('SpamTrawler_Filter_Word_SeparatorToCamelCase', '_strtoupperArray'));
        } else {
