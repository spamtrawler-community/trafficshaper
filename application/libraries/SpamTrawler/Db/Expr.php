 ...
 * is that you can use SpamTrawler_Db_Expr in the SpamTrawler_Db_Select::order() method to
 ...
 * specified to methods of SpamTrawler_Db classes, if the value is an instance of
 * SpamTrawler_Db_Expr instead of a plain string, then the expression is not quoted.
